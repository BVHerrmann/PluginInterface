...
/* activate event triggered sockets for OpenBSD configuration */

#if SOCK_CFG_OPEN_BSD
#define SOCK_INT_CFG_SOCKET_EVENTS 1
#else
#define SOCK_INT_CFG_SOCKET_EVENTS 0
#endif
...
/*===========================================================================*/
	...
	#endif
//#else
//#error one of the above must be 1
#endif
...
SOCK_SOCKET_PTR sock_socket_alloc(SOCK_CHANNEL_PTR_TYPE channel, SOCK_LOW_HANDLE_TYPE lower_handle_ptr, LSA_INT32 type);
