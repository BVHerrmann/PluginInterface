 ...
 */
/* --------------------------------------------------------------------------*/
#define INTEL_BITI(bitname,value)        EDDS_WRITE_BIT_FOR_MASK(bitname, value)
#define INTEL_BIT(bitname,value)         INTEL_BITI(bitname,value)

#define INTEL_BITSI(start,end,value)     EDDS_WRITE_BITS_FOR_MASK(start, end, value)
#define INTEL_BITS(bitsname,value)       INTEL_BITSI(bitsname##_s,bitsname##_e,value)

#define INTEL_GETBITI(bitname,value)     EDDS_GET_BIT(value, bitname)
#define INTEL_GETBIT(bitname,value)      INTEL_GETBITI(bitname,value)

#define INTEL_GETBITSI(start,end,value)  EDDS_GET_BITS(value, start, end)
#define INTEL_GETBITS(bitsname,value)    INTEL_GETBITSI(bitsname##_s,bitsname##_e,value)

#define INTEL_SETBITI(lvalue,bitname)    EDDS_SET_BIT(lvalue, bitname)
#define INTEL_SETBIT(lvalue,bitname)     INTEL_SETBITI(lvalue,bitname)

#define INTEL_CLRBITI(lvalue,bitname)    EDDS_CLR_BIT(lvalue, bitname)
#define INTEL_CLRBIT(lvalue,bitname)     INTEL_CLRBITI(lvalue,bitname)

#define INTEL_CLRBITSI(lvalue,start,end) EDDS_CLR_BITS(lvalue, start, end)
#define INTEL_CLRBITS(lvalue,bitsname)   INTEL_CLRBITSI(lvalue,bitsname##_s,bitsname##_e)
  
#define INTEL_SETBITSI(lvalue,start,end,value) EDDS_WRITE_BITS(lvalue, start, end, value)
...
#define intel_reg64(addr)             	( ((volatile LSA_UINT64*)intel_basereg)[addr/8] )
#define intel_reg32(addr)             	( ((volatile LSA_UINT32*)intel_basereg)[addr/4] )
...
/* --------------------------------------------------------------------------*/
/* PCS (Physical Coding Sub layer) Interface                                 */
/* --------------------------------------------------------------------------*/

#define INTEL_PCS_CFG             0x04200
#define INTEL_PCS_CFG_ENABLE      3
