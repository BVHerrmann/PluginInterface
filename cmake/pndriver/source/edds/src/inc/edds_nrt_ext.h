...
LSA_EXTERN LSA_BOOL EDDS_LOCAL_FCT_ATTR EDDS_NRTFilterARPFrame(
    EDDS_LOCAL_DDB_PTR_TYPE     pDDB,
    EDD_UPPER_MEM_U8_PTR_TYPE   pBuffer,
    LSA_BOOL                    VLANTagPresent);

LSA_EXTERN LSA_BOOL EDDS_LOCAL_FCT_ATTR EDDS_NRTFilterXRTFrame(
    EDDS_LOCAL_DDB_PTR_TYPE     pDDB,
    EDD_UPPER_MEM_U8_PTR_TYPE   pBuffer,
    LSA_UINT32                  Length,
    LSA_BOOL                    VLANTagPresent,
...
LSA_EXTERN LSA_VOID EDDS_LOCAL_FCT_ATTR EDDS_NRTRxIndicate(
    EDDS_LOCAL_DDB_PTR_TYPE                           pDDB,
    EDD_UPPER_MEM_PTR_TYPE EDDS_LOCAL_MEM_ATTR       *pBuffer,
    LSA_UINT32                                        pLength,
    LSA_UINT32                                        queueIdx,
...
LSA_EXTERN LSA_RESULT EDDS_LOCAL_FCT_ATTR EDDS_NRTInitComponent(
        EDD_UPPER_RQB_PTR_TYPE pRQB,
        EDDS_LOCAL_DDB_PTR_TYPE pDDB);

LSA_EXTERN LSA_RESULT EDDS_LOCAL_FCT_ATTR EDDS_NRTRelComponent(
        EDDS_LOCAL_DDB_PTR_TYPE pDDB);
