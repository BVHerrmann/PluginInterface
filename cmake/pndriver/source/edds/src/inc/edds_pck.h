...
/*  01.12.06    JS    #ifdef EDDS_XRT_OVER_UDP_INCLUDE removed           */
#endif
/*****************************************************************************/
...
/*  PACKED STRUCTS ON                                                        */
/*---------------------------------------------------------------------------*/
#include "pnio_pck4_on.h"   // should not really be necessary here, because
	                        // all structs are native aligned
...
typedef PNIO_PACKED_ATTRIBUTE_PRE union _EDDS_TYPE_LEN_FRAME_ID_TYPE
{
    struct
    {
        LSA_UINT16  TypeLen;
...
} PNIO_PACKED_ATTRIBUTE_POST EDDS_TYPE_LEN_FRAME_ID_TYPE;
...
typedef PNIO_PACKED_ATTRIBUTE_PRE union _EDDS_MAC_TYPE
{
    struct
    {
        LSA_UINT16  Dummy;
...
} PNIO_PACKED_ATTRIBUTE_POST EDDS_MAC_TYPE;
...
typedef PNIO_PACKED_ATTRIBUTE_PRE union _EDDS_IP_TYPE
{
    LSA_UINT32 dw;
...
} PNIO_PACKED_ATTRIBUTE_POST EDDS_IP_TYPE;
...
typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_IP_HEADER_TYPE
{
    ...
    EDDS_IP_TYPE       SrcIP;
    EDDS_IP_TYPE       DestIP;
} PNIO_PACKED_ATTRIBUTE_POST EDDS_IP_HEADER_TYPE; /* total ip header length: 20 bytes (=160 bits) */

typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_IP_HEADER_TYPE EDD_UPPER_MEM_ATTR * EDDS_IP_FRAME_PTR_TYPE;
...
#define EDDS_IP_VRRP        112     /* VRRP-Protocol              */
...
typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_UDP_HEADER_TYPE
{
    LSA_UINT16         SrcPort;
    LSA_UINT16         DstPort;
    LSA_UINT16         Length;
    LSA_UINT16         Checksum;
} PNIO_PACKED_ATTRIBUTE_POST EDDS_UDP_HEADER_TYPE;
...
typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_UDP_XRT_FRAME_TYPE
{
    EDDS_IP_HEADER_TYPE  Ip;       /* 20 Bytes/5 DWORDs*/
    EDDS_UDP_HEADER_TYPE Udp;      /*  8 Bytes/2 DWORDs*/
    EDDS_FRAME_ID_TYPE   FrameID;      /*  2 Bytes         */
    LSA_UINT16           Data;
} PNIO_PACKED_ATTRIBUTE_POST EDDS_UDP_XRT_FRAME_TYPE;

typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_UDP_XRT_FRAME_TYPE EDD_UPPER_MEM_ATTR * EDDS_UDP_XRT_FRAME_PTR_TYPE;
...
typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_ARP_FRAME_TYPE
{
...
} PNIO_PACKED_ATTRIBUTE_POST EDDS_ARP_FRAME_TYPE;

typedef PNIO_PACKED_ATTRIBUTE_PRE struct _EDDS_ARP_FRAME_TYPE EDD_UPPER_MEM_ATTR * EDDS_ARP_FRAME_PTR_TYPE;
