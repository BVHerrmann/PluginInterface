...
#define __Flash_h__
	...
	#define	PNDEV_DIM_ARRAY_FLASH_TYPE	3
	...
	typedef enum _ePNDEV_FLASH_TYPE
	{
		...
		ePNDEV_FLASH_TYPE_SPI_A25LQ032  	= 8,
		ePNDEV_FLASH_TYPE_NOR_S29AL032D		= 9,
		ePNDEV_FLASH_TYPE_NOR_STM29W320EB	= 10,
		ePNDEV_FLASH_TYPE_NOR_MX29LV320CB	= 11,
		ePNDEV_FLASH_TYPE_SPI_M25P10A		= 12,
		ePNDEV_FLASH_TYPE_NAND_TC58NVG0S3E  = 13
	}
	ePNDEV_FLASH_TYPE;
	...
	typedef struct _uPNDEV_FLASH_NAND_ECC_PAR
	{
		UINT32			lEccSize;
		UINT32			lEccBytes;
		UINT32			lEccSteps;
		UINT32			lEccTotal;
		UINT32			lNandSpareSize;
		UINT32			lEccPos;
		UINT32			lEccCalcAddrStart;
		UINT32			lEccCalcSize;
	}
	uPNDEV_FLASH_NAND_ECC_PAR;
	...
	//------------------------------------------------------------------------
	typedef struct _uPNDEV_FLASH_DATA_CP1625									// physical structure of RemanentData stored at flash
	{
		UINT8				uDoNotUse[0x7F00];		// These are the data in the sector which are not used by us, but we need to read them

		UINT8				uCrc32[4];
		UINT8				uLengthOfBlock[2];
		UINT8				uBlockDataVersion[2];
		UINT8				uMacAdr1[6];
		UINT8				uMacAdr2[6];
		UINT8				uMacAdr3[6];
		UINT8				uMacAdr4[6];
		UINT8				uSerialNumber[18];
		UINT8				uMlfb[20];
		UINT8				uFunctionalState[2];
		UINT8				uReserved[184];											// added because of alignment
	}
	uPNDEV_FLASH_DATA_CP1625;
