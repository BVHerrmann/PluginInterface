...
#ifdef PNDEV_TRACE
#include "Board_I210.tmh"
#endif

#ifdef ALLOC_PRAGMA
//	- don't permit paging (see...)
//	#pragma alloc_text (PAGE, fnBoard_I210_Reset)
//	#pragma alloc_text (PAGE, fnBoard_I210_ResetHw)
//	#pragma alloc_text (PAGE, fnBoard_I210_InitHw1)
//	#pragma alloc_text (PAGE, fnBoard_I210_InitHw2)
//	#pragma alloc_text (PAGE, fnBoard_I210_VerifyHwAfterReset)
//	#pragma alloc_text (PAGE, fnBoard_I210_GetMacAdress)
#endif
                            ...
                            _TCHAR*						sErrorOut)
{
        ...
        // success
    {
        ...
        else
        {
            ...
            if (fnBoard_I210_InitHw1(   pDevExtIn,
                                        bStopDefaultFw,
                                        lDimErrorIn,
                                        sErrorOut))
                // initializing hardware (phase 1) ok
            {
                ...
                else
                {
                    ...
                    bResultHwReset = fnBoard_I210_ResetHw(  pDevExtIn,
                                                            lDimErrorIn,
                                                            sErrorOut);
                }
                    ...
                    // success
                {
                    ...
                    {
                        if (fnBoard_I210_InitHw2(   pDevExtIn,
                                                    bResetHw,
                                                    lDimErrorIn,
                                                    sErrorOut))
                            // initializing hardware (phase 2) ok
                        {
                            if (fnBoard_I210_VerifyHwAfterReset(pDevExtIn,
                                                                lDimErrorIn,
                                                                sErrorOut))
                                ...
                                _TCHAR*				sErrorOut)
{
    ...
    // MSIX interrupts
    {
        ...
        WRITE_REG_UINT32(pDevExtIn->uHwResKm.uBoard.as.uI210.uBar0.pPtr + BOARD_I210__GPIE,
        ...
        WRITE_REG_UINT32(pDevExtIn->uHwResKm.uBoard.as.uI210.uBar0.pPtr + BOARD_I210__IVAR_MISC,
                        PNDEV_UINT32_SET_BIT_15);

        // set EIMS, bit for masking OtherInterrupt in EICR Register
        WRITE_REG_UINT32(pDevExtIn->uHwResKm.uBoard.as.uI210.uBar0.pPtr + BOARD_I210__EIMS,
                        PNDEV_UINT32_SET_BIT_0);

        // set EIAC, bit for auto clearing EICR (OtherInterrupt)
        WRITE_REG_UINT32(pDevExtIn->uHwResKm.uBoard.as.uI210.uBar0.pPtr + BOARD_I210__EIAC,
                        PNDEV_UINT32_SET_BIT_0);
    }
                                    ...
                                    _TCHAR*				sErrorOut)
{
    ...
    UINT32			lMacAddrHigh = BOARD_I210__RAH;
    UINT32			lMacAddrLow = BOARD_I210__RAL;
