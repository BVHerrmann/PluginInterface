...
BOOLEAN	bResult = FALSE;
			...
			// BoardType
	{
		...
		{		
			...
			(void)READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8841.uBar0.pPtr + BOARD_MICREL_KSZ88XX__GRR);
		...
		{		
			...
			// PciRead for PostedWrite
			(void)READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__GRR);
			...
			// BoardType
	{
		...
		{		
			...
			WRITE_REG_UINT16(	(pDevExtIn->uHwResKm.uBoard.as.uKSZ8841.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4),
								(READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8841.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4)) | PNDEV_UINT32_SET_BIT_14);
			
			// read phy power
			(void)READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8841.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4);
			...
			//lint --e(550) lTmpValue not accessed - yes, but it is needed, // PciRead for PostedWrite
		}
		case ePNDEV_BOARD_MICREL_KSZ8842:	// Micrel KSZ8842 board
		{		
			// set phy power off Port1
			WRITE_REG_UINT16(	(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4),
								(READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4)) | PNDEV_UINT32_SET_BIT_14);
			
			// read phy power
			(void)READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P1CR4);
			

			// set phy power off Port2
			WRITE_REG_UINT16(	(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P2CR4),
								(READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P2CR4)) | PNDEV_UINT32_SET_BIT_14);
			
			// read phy power
			(void)READ_REG_UINT16(pDevExtIn->uHwResKm.uBoard.as.uKSZ8842.uBar0.pPtr + BOARD_MICREL_KSZ88XX__P2CR4);
...
volatile UINT8* pBase 	= NULL;
	...
	lTmpValue2 = READ_REG_UINT16(pBase + BOARD_MICREL_KSZ88XX__MARH);
		...
		pDevExtIn->uRemanentData.lArrayMacAdr[0][4] = (lTmpValue0>>8)&0xFF; 
		pDevExtIn->uRemanentData.lArrayMacAdr[0][5] = lTmpValue0 & 0xFF;
				
		pDevExtIn->uRemanentData.lArrayMacAdr[0][2] = (lTmpValue1>>8)&0xFF; 
		pDevExtIn->uRemanentData.lArrayMacAdr[0][3] = lTmpValue1 & 0xFF;
				
		pDevExtIn->uRemanentData.lArrayMacAdr[0][0] = (lTmpValue2>>8)&0xFF; 
		pDevExtIn->uRemanentData.lArrayMacAdr[0][1] = lTmpValue2 & 0xFF;
		
		// don't calculate port mac addresse, because it wil be done by EddsOpen
		/*
