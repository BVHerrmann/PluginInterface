...
#define __PnDev_DriverU_h__
	...
	#define PNDEVDRV_KIND               	/* &K */ 'P'  /* K& */
											...
											/*              'K': correction    */
											/*              'D': demonstration */
	#define PNDEVDRV_VERSION            	/* &V */ 4    /* V& */ /* [1 - 99] */
	#define PNDEVDRV_DISTRIBUTION       	/* &D */ 1	  /* D& */ /* [0 - 99] */
	#define PNDEVDRV_FIX                	/* &F */ 0    /* F& */ /* [0 - 99] */
	#define PNDEVDRV_HOTFIX             	/* &H */ 0    /* H& */ /* [0]      */
	#define PNDEVDRV_PROJECT_NUMBER     	/* &P */ 0    /* P& */ /* [0 - 99] */
														  /* At LSA always 0!  */
	#define PNDEVDRV_INCREMENT				/* &I */ 4    /* I& */ /* [1 - 99] */
	#define PNDEVDRV_INTEGRATION_COUNTER 	/* &C */ 3    /* C& */ /* [1 - 99] */
	...
	#define	PNDEV_MAC_ADR_MIN__ERTEC400		(4u+1u)								// 4x Port + 1x Interface
	#define	PNDEV_MAC_ADR_MIN__ERTEC200		(2u+1u)								// 2x Port + 1x Interface
	#define	PNDEV_MAC_ADR_MIN__SOC1			(3u+1u)								// 3x Port + 1x Interface
	#define	PNDEV_MAC_ADR_MIN__ERTEC200P	(2u+1u)								// 2x Port + 1x Interface
    #define	PNDEV_MAC_ADR_MIN__HERA	        (4u+2u)								// 4x Port + 2x Interface
	#define	PNDEV_MAC_ADR_MIN__AM5728	    (4u+1u)								// 4x Port + 1x Interface
	...
	#define PNDEV_EVENT_SYNC_TICK			100
	...
	typedef enum _ePNDEV_BOARD
	{
		...
		ePNDEV_BOARD_TI_AM5728			= 13,									// TI AM5728 board
		ePNDEV_BOARD_DB_EB200_PCIE		= 14,									// DB-EB200-PCIe board
		ePNDEV_BOARD_I210SFP			= 15,									// Femrice I210SFP board
		ePNDEV_BOARD_IX1000				= 16,									// Intel Quark X1000 on Galileo board
		ePNDEV_BOARD_CP1625				= 17									// CP1625 board
	}
	ePNDEV_BOARD;
	...
	typedef enum _ePNDEV_BOARD_DETAIL
	{
		...
		ePNDEV_BOARD_DETAIL_ERTEC200_XHIF			= 6
	}
	ePNDEV_BOARD_DETAIL;
	...
	typedef enum _ePNDEV_ASIC
	{
		...
		ePNDEV_ASIC_I210IS		= 11,
		ePNDEV_ASIC_IX1000		= 12
	}
	ePNDEV_ASIC;
	...
	typedef enum _ePNDEV_ASIC_DETAIL
	{
		...
		ePNDEV_ASIC_DETAIL_PNIP_REV3			= 9
	}
	ePNDEV_ASIC_DETAIL;
	...
	typedef enum _ePNDEV_EVENT_CLASS
	{
		...
		ePNDEV_EVENT_CLASS_TICK			= 7,
		ePNDEV_EVENT_CLASS_SYNC_TICK	= 8
	}
	ePNDEV_EVENT_CLASS;
	...
	typedef enum _ePNDEV_INT_SRC
	{
		...
		ePNDEV_INT_SRC_SOC__IRTE_IRQ0		= 14,
		ePNDEV_INT_SRC_SOC__SW_IRQ_14		= 15,
		...
		// Hera
		//--------------------------------------------------------------------
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_SUM		= 112,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT12	= 113,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT13	= 114,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT14	= 115,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT15	= 116,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT16	= 117,
		ePNDEV_INT_SRC_HERA__XGMDA_JOB_DONE_INT20	= 118,
		ePNDEV_INT_SRC_HERA__WD_OUT0				= 119,	
		ePNDEV_INT_SRC_HERA__SCRB_SW_INT14			= 120,
		ePNDEV_INT_SRC_HERA__SCRB_SW_INT15			= 121,
		ePNDEV_INT_SRC_HERA__SCRB_SW_INT16			= 122,
		ePNDEV_INT_SRC_HERA__SCRB_SW_INT17			= 123,
		ePNDEV_INT_SRC_HERA__GPIO_EXT_INT_0			= 124,
		ePNDEV_INT_SRC_HERA__GPIO_EXT_INT_4			= 125,
		ePNDEV_INT_SRC_HERA__GPIO_EXT_INT_8			= 126,
		ePNDEV_INT_SRC_HERA__GPIO_EXT_INT_9			= 127,	
		ePNDEV_INT_SRC_HERA__PNIP_IFA_ICU_IRQ0		= 128,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_ICU_IRQ1		= 129,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ2		= 130,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ3		= 131,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ4		= 132,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ5		= 133,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ6		= 134,
		ePNDEV_INT_SRC_HERA__PNIP_IFA_MUX_IRQ7		= 135,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_ICU_IRQ0		= 136,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_ICU_IRQ1		= 137,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ2		= 138,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ3		= 139,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ4		= 140,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ5		= 141,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ6		= 142,
		ePNDEV_INT_SRC_HERA__PNIP_IFB_MUX_IRQ7		= 143,

		//--------------------------------------------------------------------
		// I210SFP
		//--------------------------------------------------------------------
		ePNDEV_INT_SRC_I210SFP						= 144,
		
		//--------------------------------------------------------------------
		// IX1000
		//--------------------------------------------------------------------
		ePNDEV_INT_SRC_IX1000						= 145,

		//--------------------------------------------------------------------
		// IntTest
		//--------------------------------------------------------------------
		ePNDEV_INT_SRC_TEST	= 146												// must be last element!
	}
	ePNDEV_INT_SRC;

	#define	PNDEV_DIM_ARRAY_INT_SRC	(ePNDEV_INT_SRC_TEST + 1)
	
	#define PNDEV_MSIX_VECTOR_COUNT_MAX	32
	...
	//------------------------------------------------------------------------
	typedef enum _ePNDEV_FW_TYPE
	{
		ePNDEV_FW_TYPE_INVALID	= 0,
		ePNDEV_FW_TYPE_ADONIS	= 1,
		ePNDEV_FW_TYPE_LINUX	= 2,
		ePNDEV_FW_TYPE_BOOT		= 3
	}
	ePNDEV_FW_TYPE;
	...
	typedef enum _ePNDEV_FLASH_ACTION
	{
		...
		ePNDEV_FLASH_ACTION_PROGRAM_CP1625		= 5
	}
	ePNDEV_FLASH_ACTION;
	...
	typedef void	(__stdcall * PNDEV_CBF_ISR)(		const HANDLE				hDeviceIn,
														...
														const void*					pCbfParUserIn);
	typedef void	(__stdcall * PNDEV_CBF_TICK)(		const HANDLE				hDeviceIn,
														const ePNDEV_EVENT_CLASS	eEventClassIn,
														const void*					pCbfParUserIn);
...
//	#pragma pack(show)
	...
	//------------------------------------------------------------------------
	typedef	union _uPNDEV64_CBF_TICK
	{
		PNDEV_CBF_TICK	pPtr;
		UINT64			lUint64;
	}
	...
	//------------------------------------------------------------------------
	typedef struct _uPNDEV_KTIMER_IOCTL
	{
		uPNDEV64_HANDLE uEventUtmrTick;
		uPNDEV64_HANDLE uEventUtmrTickSynch;
	}
	uPNDEV_KTIMER_IOCTL;
	...
	{
		uPNDEV_HW_DESC	uPcieUL;
		uPNDEV_HW_DESC	uScrb;
		uPNDEV_HW_DESC	uSecScrb;
		uPNDEV_HW_DESC	uGpio;
		uPNDEV_HW_DESC	uTimerA_0_5;
		uPNDEV_HW_DESC	uTimerB_0_5;
		uPNDEV_HW_DESC	uTimerC_0_5;
		uPNDEV_HW_DESC	uWatchdogA;
		uPNDEV_HW_DESC	uWatchdogB;
		uPNDEV_HW_DESC	uWatchdogC;
		uPNDEV_HW_DESC	uWatchdogD;
		uPNDEV_HW_DESC	uWatchdogE;
		uPNDEV_HW_DESC	uFTimer;
		uPNDEV_HW_DESC	uI2C1_1;
		uPNDEV_HW_DESC	uI2C1_2;
		uPNDEV_HW_DESC	uI2C1_3;
		uPNDEV_HW_DESC	uUart_1_3;
		uPNDEV_HW_DESC	uSpi1;
		uPNDEV_HW_DESC	uSpi2;
		uPNDEV_HW_DESC	uSpi3;
		uPNDEV_HW_DESC	uSpi4;
		uPNDEV_HW_DESC	uGtb;
	}
	uPNDEV_HW_DESC_APB_PER_HERA;
	//------------------------------------------------------------------------
	
	typedef	struct _uPNDEV_HW_DESC_APB_PER_AM5728
	{
		uPNDEV_HW_DESC	uGpio;
	...
	typedef struct _uPNDEV_HW_RES
	{
		...
		union
		{
			...
			struct
			{
				...
				uPNDEV_HW_DESC				uXgdma;
				uPNDEV_HW_DESC				uR4_CORE_A_Btcm;
				uPNDEV_HW_DESC				uR4_CORE_A_TimerReg;
				uPNDEV_HW_DESC				uR4_CORE_A_VIC;
				uPNDEV_HW_DESC				uR4_CORE_A_Atcm;
				uPNDEV_HW_DESC				uR4_CORE_B_Btcm;
				uPNDEV_HW_DESC				uR4_CORE_B_TimerReg;
				uPNDEV_HW_DESC				uR4_CORE_B_VIC;
				uPNDEV_HW_DESC				uR4_CORE_B_Atcm;
				uPNDEV_HW_DESC				uPnIp_A;
				uPNDEV_HW_DESC				uPnIp_B;
			...
			struct
			{
				...
				uPNDEV_HW_DESC			uPruss2Config;
				uPNDEV_HW_DESC			uPruss2;
				uPNDEV_HW_DESC	        uQspiReg;
				uPNDEV_HW_DESC_SDRAM	uEmifSdram;
				
				uPNDEV_HW_DESC_APB_PER_AM5728	uApbPer;			// Gpio, Uart, I2C
    ...
    typedef struct _uPNDEV_GET_SHARED_HOST_MEM_ADDR_INTERNAL_IN
    {
        uPNDEV64_HANDLE uAppSys;
    }
    uPNDEV_GET_SHARED_HOST_MEM_ADDR_INTERNAL_IN;

    //------------------------------------------------------------------------
    typedef struct _uPNDEV_GET_SHARED_HOST_MEM_ADDR_IN
    {
        uPNDEV_GET_SHARED_HOST_MEM_ADDR_INTERNAL_IN uInternal;
    }
    uPNDEV_GET_SHARED_HOST_MEM_ADDR_IN;

    //------------------------------------------------------------------------
    typedef struct _uPNDEV_GET_SHARED_HOST_MEM_ADDR_OUT
    {
        PNDEV_CHAR                  sError[PNDEV_SIZE_STRING_BUF];
        uPNDEV_SHARED_HOST_SDRAM    SharedHostSdram;
    }
    uPNDEV_GET_SHARED_HOST_MEM_ADDR_OUT;
	...
	typedef struct _uPNDEV_OPEN_TIMER_INTERNAL_IN
	{
		uPNDEV_KTIMER_IOCTL uKTimerIoctl;
	}
	uPNDEV_OPEN_TIMER_INTERNAL_IN;

	//------------------------------------------------------------------------
	typedef struct _uPNDEV_OPEN_TIMER_INTERNAL_OUT
	{
		uPNDEV64_HANDLE		uReceiverSys;
	}
	uPNDEV_OPEN_TIMER_INTERNAL_OUT;

	//------------------------------------------------------------------------
	typedef struct _uPNDEV_OPEN_TIMER_IN
	{
		uPNDEV64_HANDLE	    uDevice;
		uPNDEV64_CBF_TICK	uCbfTick;
		uPNDEV64_PTR_VOID	uCbfParUser;
		uPNDEV_THREAD_DLL	uThreadKTimer;

		uPNDEV_OPEN_TIMER_INTERNAL_IN uInternal;
	}
	uPNDEV_OPEN_TIMER_IN;

	//------------------------------------------------------------------------
	typedef struct _uPNDEV_OPEN_TIMER_OUT
	{
		PNDEV_CHAR				sError[PNDEV_SIZE_STRING_BUF];
		uPNDEV64_HANDLE			uTimer;

		uPNDEV_OPEN_TIMER_INTERNAL_OUT	uInternal;
	}
	uPNDEV_OPEN_TIMER_OUT;

	//========================================================================
	//	service CloseTimer
	//========================================================================

	typedef struct _uPNDEV_CLOSE_TIMER_INTERNAL_IN
	{
		uPNDEV64_HANDLE		uReceiverSys;
	}
	uPNDEV_CLOSE_TIMER_INTERNAL_IN;

	//------------------------------------------------------------------------
	typedef struct _uPNDEV_CLOSE_TIMER_IN
	{
		uPNDEV64_HANDLE		uTimer;

		uPNDEV_CLOSE_TIMER_INTERNAL_IN	uInternal;
	}
	uPNDEV_CLOSE_TIMER_IN;

	//------------------------------------------------------------------------
	typedef struct _uPNDEV_CLOSE_TIMER_OUT
	{
		PNDEV_CHAR sError[PNDEV_SIZE_STRING_BUF];
	}
	uPNDEV_CLOSE_TIMER_OUT;
...
//------------------------------------------------------------------------
    struct uPNDEV_NP_KERNEL_TMP_REQ_SETUP_FILTER_EVENTS_IN
    {
        uNP_EVENT_CONFIG uFilterEventConfig[kNP_MAX_NUMBER_OF_EVENTS];
    };
//------------------------------------------------------------------------
    struct uPNDEV_NP_KERNEL_TMP_REQ_SETUP_FILTER_EVENTS_OUT
    {
        UINT32 dummy;
    };
//------------------------------------------------------------------------
    struct uPNDEV_NP_KERNEL_TMP_REQ_GET_FILTER_EVENTS_IN
    {
        UINT32 dummy;
    };
//------------------------------------------------------------------------
    struct uPNDEV_NP_KERNEL_TMP_REQ_GET_FILTER_EVENTS_OUT
    {
        UINT16 lnumberOfEvents;
        uNP_FILTER_EVENT_DATA uFilterEventData[kNP_MAX_NUMBER_OF_EVENT_DATA];
    };
//------------------------------------------------------------------------
	union uPNDEV_NP_KERNEL_TMP_SPEC_REQ_DRIVER_IN
	{
		...
		struct  uPNDEV_NP_KERNEL_TMP_REQ_SETUP_FILTER_EVENTS_IN uSetupFilterEvents;
		struct  uPNDEV_NP_KERNEL_TMP_REQ_GET_FILTER_EVENTS_IN uGetFilterEvents;
	};
//------------------------------------------------------------------------
	union uPNDEV_NP_KERNEL_TMP_SPEC_REQ_DRIVER_OUT
	{
		...
		struct  uPNDEV_NP_KERNEL_TMP_REQ_SETUP_FILTER_EVENTS_OUT uSetupFilterEvents;
		struct  uPNDEV_NP_KERNEL_TMP_REQ_GET_FILTER_EVENTS_OUT uGetFilterEvents;
	};
//------------------------------------------------------------------------
...
*/
    ...
    typedef ePNDEV_RESULT   (*PNDEV_FN_GET_SHARED_HOST_MEM_ADDR)(   HANDLE                          hDriverIn,
                                                                    const UINT32                    lSizeInputBufIn,
                                                                    const UINT32                    lSizeOutputBufIn,
	...
	typedef ePNDEV_RESULT	(*PNDEV_FN_OPEN_TIMER)(			HANDLE							hDriverIn,
															const UINT32					lSizeInputBufIn,
															const UINT32					lSizeOutputBufIn,
															uPNDEV_OPEN_TIMER_IN*			pIn,
															uPNDEV_OPEN_TIMER_OUT*			pOut);
	typedef ePNDEV_RESULT	(*PNDEV_FN_CLOSE_TIMER)(		HANDLE							hDriverIn,
															const UINT32					lSizeInputBufIn,
															const UINT32					lSizeOutputBufIn,
...
//	#pragma pack(show)
	...
	typedef struct _uPNDEV_FCT_PTR
	{
		...
		PNDEV_FN_OPEN_TIMER			pFnOpenTimer;
		PNDEV_FN_CLOSE_TIMER		pFnCloseTimer;
        PNDEV_FN_DO_NETPROFI       	pFnDoNetProfi;
        PNDEV_FN_GET_SHARED_HOST_MEM_ADDR      pFnGetSharedHostMemAddr;
	}
	uPNDEV_FCT_PTR;
