...
{
#if !defined(PNDEV_SUPPORT_OTHERS) && !defined(PNDEV_SUPPORT_I210) && !defined(PNDEV_SUPPORT_I210SFP) && !defined(PNDEV_SUPPORT_I82574) && !defined(PNDEV_SUPPORT_IX1000)
    LSA_UNUSED_ARG(eAsicIn);
    LSA_UNUSED_ARG(eIcuIn);
    LSA_UNUSED_ARG(pIntParOut);
...
LSA_BOOL eResult = LSA_TRUE;
			...
			// AsicType
	{
		...
		{
			// IRQ0/IRQ1: combined interrupts, IRQ2/../IRQ7: single interrupts
			...
			{
				// IRQ0 for EDDP interrupts -> use IRQ1 of PN-ICU2, use EventLow.Int23
				pIntParOut->lOffsetIrrReg	= PNIP_REG_IRQ2EVENT_LOW_1;
				pIntParOut->lOffsetAckReg	= PNIP_REG_IRQ2ACK_LOW_1;
				pIntParOut->lOffsetMaskReg	= PNIP_REG_IRQ2MASK_LOW_1;
				pIntParOut->lOffsetIrReg	= PNIP_REG_IRQ2_LOW_1;
        ...
        #if defined(PNDEV_SUPPORT_I210) || defined(PNDEV_SUPPORT_I210SFP) || defined(PNDEV_SUPPORT_I82574) || defined(PNDEV_SUPPORT_IX1000)
