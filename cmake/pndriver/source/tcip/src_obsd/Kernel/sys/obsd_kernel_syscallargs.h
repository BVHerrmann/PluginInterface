...
struct sys_fork_ex_args {
	syscallarg(const char *) proc_name;
	syscallarg(int (*func)(void *) );
	syscallarg(void * ) func_arg;
};
...
int	sys_mmap(struct proc *, void *, void **);
int sys_get_mmap_size(struct proc *, void *);
...
int sys_fork_ex(struct proc *p, void *v, register_t *retval);
int sys_vfork_ex(struct proc *p, void *v, register_t *retval);
