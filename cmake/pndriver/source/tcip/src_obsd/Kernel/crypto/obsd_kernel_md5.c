...
#define PUT_64BIT_LE(cp, value) do {					\
	(cp)[7] = (u_int8_t)((value) >> 56);					\
	(cp)[6] = (u_int8_t)((value) >> 48);					\
	(cp)[5] = (u_int8_t)((value) >> 40);					\
	(cp)[4] = (u_int8_t)((value) >> 32);					\
	(cp)[3] = (u_int8_t)((value) >> 24);					\
	(cp)[2] = (u_int8_t)((value) >> 16);					\
	(cp)[1] = (u_int8_t)((value) >> 8);						\
	(cp)[0] = (u_int8_t) (value); } while (0)
...
MD5Final(unsigned char digest[MD5_DIGEST_LENGTH], MD5_CTX *ctx)
{
	...
	padlen = (size_t)(MD5_BLOCK_LENGTH -  /* gerlach/gh2289n: added explicit type cast to avoid compiler warning C4244 */
...
#define MD5STEP(f, w, x, y, z, data, s) \
	( w += f(x, y, z) + (data),  w = w<<s | w>>(32-s),  w += x )	/* mh2290: LINT 665   Unparenthesized parameter Integer in macro 'Symbol' is passed an expression */
