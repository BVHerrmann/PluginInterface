...
#define TCIP_INT_CFG_SOCKET_EVENTS 1
#else
#define TCIP_INT_CFG_SOCKET_EVENTS 0
#endif
...
extern void tcip_obsd_mib2_written(const void * snmp_data);
#endif
...
#endif
#if TCIP_CFG_OPEN_BSD
#define TCIP_MAX_MIBII_IFSTRING_LEN OBSD_PNIO_IFDESCRSIZE
#endif
...
LSA_UINT8 tcip_iniche_set_gateway(LSA_UINT32 gateway);
#endif
