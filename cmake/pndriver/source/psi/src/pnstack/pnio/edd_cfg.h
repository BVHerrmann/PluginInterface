...
LSA_UINT16 psi_edd_get_mailbox_id( // Lookup for Mailbox ID (dependent of EDDx)
	const LSA_VOID_PTR_TYPE const rqb_ptr,
	LSA_UINT16              const comp_id_upper,
	LSA_SYS_PTR_TYPE        const sys_ptr
);

EDD_REQUEST_FCT psi_edd_get_open_fct( // Lookup for open channel function
	LSA_UINT16 const comp_id_edd
);

EDD_REQUEST_FCT psi_edd_get_close_fct( // Lookup for close channel function
	LSA_UINT16 const comp_id_edd
);

EDD_REQUEST_FCT psi_edd_get_request_fct( // Lookup for request function
	LSA_UINT16 const comp_id_edd
);
...
/*       by the EDD.                                                         */
/*---------------------------------------------------------------------------*/
#define EDD_CFG_MAX_INTERFACE_CNT (PSI_CFG_EDD_CFG_MAX_INTERFACE_CNT)
...
/*---------------------------------------------------------------------------*/
#define EDD_CFG_MAX_PORT_CNT (PSI_CFG_EDD_CFG_MAX_PORT_CNT)
...
/*---------------------------------------------------------------------------*/
#define EDD_CFG_MAX_PORT_CNT_ALL_INTERFACE (PSI_CFG_EDD_CFG_MAX_PORT_CNT_ALL_INTERFACE)

/*---------------------------------------------------------------------------*/
/* Maximum number of MRP instances supported with a EDD interface            */
/*---------------------------------------------------------------------------*/
#define EDD_CFG_MAX_MRP_INSTANCE_CNT (PSI_CFG_EDD_CFG_MAX_MRP_INSTANCE_CNT)

/*---------------------------------------------------------------------------*/
/* Maximum number of MRP interconnection instances supported by EDD interface*/
/*---------------------------------------------------------------------------*/
#define EDD_CFG_MAX_MRP_IN_INSTANCE_CNT (PSI_CFG_EDD_CFG_MAX_MRP_IN_INSTANCE_CNT)
...
#define EDD_CFG_CSRT_MAX_INDICATIONS (PSI_CFG_MAX_CRT_FRAMES_PER_CYCLE)

/*---------------------------------------------------------------------------*/
/* Max number of provider groups supported.                                  */
/* (1..0xFFFF)                                                               */
/* Attention: EDDP supports up to 7 groups only!                             */
/*---------------------------------------------------------------------------*/
