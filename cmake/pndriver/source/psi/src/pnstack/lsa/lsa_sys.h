...
/*                                  neu.                                     */
/* 2015-07-02 P2.1.0.0_0.15.1.1 st  1361269  define LSA_COMP_ID_DNS          */
/*                                                                           */
/*****************************************************************************/
...
#define LSA_COMP_ID_EDDI      0x002f /* Ethernet-Device-Driver for IRTE      */
                                     /* (Classic), new Software Versions     */
#define LSA_COMP_ID_EDDP      0x0030 /* Ethernet-Device-Driver for PNIP      */
...
#define LSA_COMP_ID_DNS       0x0037 /* Domain Name Service                  */
#define LSA_COMP_ID_HSA		  0x0038 /* Hsync App                            */
#define LSA_COMP_ID_EDDT      0x0039 /* Ethernet-Device-Driver for TI        */
#define LSA_COMP_ID_SOCKAPP   0x003a /* Socket Application                   */
#define LSA_COMP_ID_PND       0x003b /* PROFINET Driver                      */   
#define LSA_COMP_ID_LAST      0x003c /* Always the last id in this list, used in psi_sys.h */
