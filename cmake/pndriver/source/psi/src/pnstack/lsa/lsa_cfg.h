...
/*                                                                           */
/*  V e r s i o n         &V: LSA_GLOB_P02.01.00.00_00.15.01.01 :V&          */
/*                                                                           */
/*  D a t e  (YYYY-MM-DD) &D: 2015-07-23                        :D&          */
/*                                                                           */
/*****************************************************************************/
/*                                                                           */
...
/*  2014-10-08 P2.1.0.0_0.14.1.1 st neue Typen fuer 64 Bit Systeme:          */
/*                                  LSA_UINTPTR, LSA_INTPTR, LSA_PTRDIFF,    */
/*                                  LSA_SIZE, LSA_FLOAT32, LSA_FLOAT64,      */
/*                                  Erweiterung bei Beschreibung von         */
/*                                  LSA_HOST_PTR_COMPARE_TYPE                */
/*  2014-10-09 P2.1.0.0_0.14.1.1 st Demo-Umsetzung der LSA-Trace-Makros auf  */
/*                                  LTRC-Trace-Makros entfernt /             */
/*                                  Beschreibung fuer die neuen 64-Bit-Makros*/
/*                                  alte Umsetzung von LSA_INST_... auf      */
/*                                  LSA_IDX_... rausgeworfen                 */
/*  2014-10-10 P2.1.0.0_0.14.1.1 st Beschreibung fuer die 32-Bit-Makros      */
/*  2015-04-02 P2.1.0.0_0.14.1.1 st  1139778 / 64 Bit	Vorgabe fuer         */
/*                                  LSA_USER_ID_INIT / LSA_USER_ID_ARE_EQUAL:*/
/*                                  i_ sollte vom Typ LSA_SIZE sein!         */
/* 2015-04-10 P2.1.0.0_0.14.1.1 st  1202684  Vorgabe bei LSA_TRUE ersetzt    */
/*                                  durch Erklaerungen und <value>           */
/* 2015-07-23 P2.1.0.0_0.15.1.1 st  1354771	_EXT-Trace-Makros eingefuehrt    */
/*                                                                           */
/*****************************************************************************/
...
#define LSA_HOST_ENDIANESS_LITTLE
 Note: must be defined by PSI adapting
 *===========================================================================*/
...
#define LSA_UINTPTR                 uintptr_t       /* or unsigned __int32   */
                                                    /* or unsigned __int64   */
      /* unsigned integer type capable of holding a pointer                  */
      /* 32-, 64-, etc. bit according to compiler                            */
      /* minimal range:                    0 ...                     +65 535 */

#define LSA_SIZE                    size_t          /* or unsigned int       */
      /* unsigned integer type able to represent the size of any object in   */
      /* bytes, size_t is the type returned by the sizeof operator           */
      /* 32-, 64-, etc. bit according to compiler                            */
      /* minimal range:                    0 ...                     +65 535 */
...
#define LSA_INTPTR                  intptr_t        /* or __int64 or __int32 */ 
      /* signed integer type capable of holding a pointer                    */
      /* 32-, 64-, etc. bit according to compiler                            */
      /* minimal range:        -32 768 ... 0 ...                     +32 767 */

#define LSA_PTRDIFF                 ptrdiff_t       /* or __int64 or __int32 */
...
#define LSA_FLOAT32					float
          /* IEEE 754-1985/IEEE 754-2008/IEC 60559                           */
          /* binary32 : Single-precision floating-point format               */
          /* with     : 32 bits                                              */
          /* range    : +/-1.18*10^-38 to +/-3.4*10^38                       */
          /* precision: approx. 7 decimal digits                             */

#define LSA_FLOAT64					double
          /* IEEE 754-1985/IEEE 754-2008/IEC 60559                           */
          /* binary64 : Double-precision floating-point format               */
          /* with     : 64 bits                                              */
...
#define LSA_HOST_PTR_COMPARE_TYPE   LSA_UINT64
#define LSA_HOST_PTR_COMPARE_TYPE   LSA_UINTPTR
 *===========================================================================*/
#define LSA_HOST_PTR_COMPARE_TYPE   LSA_VOID_PTR_TYPE
 ...
 * Macros with _EXT at the end have modul and line as parameters.
 *
 ...
 *
 * macro names:   LSA_TRACE_XX_EXT       (XX = 00, 01, 02, 03, ..., 16)
 *                LSA_TRACE_XX           (XX = 00, 01, 02, 03, ..., 16)
 *                LSA_IDX_TRACE_XX_EXT   (XX = 00, 01, 02, 03, ..., 16)
 *                LSA_IDX_TRACE_XX       (XX = 00, 01, 02, 03, ..., 16)
 *
 * macros:        Trace entry of 0, 1, 2, ... or 16 parameters
 *                These LSA trace macros must be mapped to system specific 
 *                trace macros, depending on the 64 bit or 32 bit platform.
 *
 *
 * macro names:   LSA_32_TRACE_YY_EXT    (YY = 00,01,02,03,...08)
 *                LSA_32_TRACE_YY        (YY = 00,01,02,03,...08)
 *                LSA_IDX_32_TRACE_YY_EXT(YY = 00,01,02,03,...08)
 *                LSA_IDX_32_TRACE_YY    (YY = 00,01,02,03,...08)
 *
 * macros:        Trace entry of 0, 1, 2, ... or 8 parameters
 *                These macros can be used for fast tracing of 32 bit parameters 
 *                in a 64 bit environment.
 *                They must be mapped to appropriate system specific macros.
 *
 *
 * macro names:   LSA_64_TRACE_YY_EXT    (YY = 00,01,02,03,...08)
 *                LSA_64_TRACE_YY        (YY = 00,01,02,03,...08)
 *                LSA_IDX_64_TRACE_YY_EXT(YY = 00,01,02,03,...08)
 *                LSA_IDX_64_TRACE_YY    (YY = 00,01,02,03,...08)
 *
 * macros:        Trace entry of 0, 1, 2, ... or 8 parameters
 *                These macros are used to trace parameters, which have 64 bit width 
 *                independant of the platform.
 *                They must be mapped to appropriate system specific macros.
 *
 *
 * macro names:   LSA_TRACE_BYTE_ARRAY_EXT
 *                LSA_TRACE_BYTE_ARRAY
 *                LSA_IDX_TRACE_BYTE_ARRAY_EXT
 ...
 *                modul_:   LTRC_ACT_MODUL_ID of the file with the tracepoint, 
 *                          only for ..._EXT-macros
 *                line_:    line number of the tracepoint, 
 *                          only for ..._EXT-macros
 *                msg_:     string similar to "printf"
 *                          only the following format specifiers are allowed:
 *                          %p for pointers
 *                          %d/%u/%i/%o/%x/%X... for integer or hex values
 *                para1_:   parameter 1
 *                para2_:   parameter 2
 *                 ...        ...
...
#define LSA_TRACE_00_EXT(subsys_, level_, modul_, line_, msg_)
#define LSA_TRACE_01_EXT(subsys_, level_, modul_, line_, msg_, para1_) 
#define LSA_TRACE_02_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_) 
#define LSA_TRACE_03_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_) 
#define LSA_TRACE_04_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_) 
#define LSA_TRACE_05_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_) 
#define LSA_TRACE_06_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) 
#define LSA_TRACE_07_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_) 
#define LSA_TRACE_08_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) 
#define LSA_TRACE_09_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_) 
#define LSA_TRACE_10_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_) 
#define LSA_TRACE_11_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_) 
#define LSA_TRACE_12_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_) 
#define LSA_TRACE_13_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_, para13_) 
#define LSA_TRACE_14_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_, para13_, para14_) 
#define LSA_TRACE_15_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_, para13_, para14_, para15_) 
#define LSA_TRACE_16_EXT(subsys_, level_, modul_, line_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_, para13_, para14_, para15_, para16_) 

#define LSA_TRACE_BYTE_ARRAY_EXT(subsys_, level_, modul_, line_, msg_, ptr_, len_)
...
#define LSA_IDX_TRACE_00_EXT(subsys, idx, level, msg)
#define LSA_IDX_TRACE_01_EXT(subsys, idx, level, msg, para1)
#define LSA_IDX_TRACE_02_EXT(subsys, idx, level, msg, para1, para2)
#define LSA_IDX_TRACE_03_EXT(subsys, idx, level, msg, para1, para2, para3)
#define LSA_IDX_TRACE_04_EXT(subsys, idx, level, msg, para1, para2, para3, para4)
#define LSA_IDX_TRACE_05_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5)
#define LSA_IDX_TRACE_06_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6)
#define LSA_IDX_TRACE_07_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7)
#define LSA_IDX_TRACE_08_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8)
#define LSA_IDX_TRACE_09_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9)
#define LSA_IDX_TRACE_10_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10)
#define LSA_IDX_TRACE_11_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11)
#define LSA_IDX_TRACE_12_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12)
#define LSA_IDX_TRACE_13_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13)
#define LSA_IDX_TRACE_14_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14)
#define LSA_IDX_TRACE_15_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15)
#define LSA_IDX_TRACE_16_EXT(subsys, idx, level, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15, para16)
...
#define LSA_IDX_TRACE_00_EXT(subsys, idx, level, module, line, msg) \
	PNTRC_TRACE_00_EXT(subsys, idx, level, module, line, msg)
#define LSA_IDX_TRACE_01_EXT(subsys, idx, level, module, line, msg, para1) \
	PNTRC_TRACE_01_EXT(subsys, idx, level, module, line, msg, para1)
#define LSA_IDX_TRACE_02_EXT(subsys, idx, level, module, line, msg, para1, para2) \
	PNTRC_TRACE_02_EXT(subsys, idx, level, module, line, msg, para1, para2)
#define LSA_IDX_TRACE_03_EXT(subsys, idx, level, module, line, msg, para1, para2, para3) \
	PNTRC_TRACE_03_EXT(subsys, idx, level, module, line, msg, para1, para2, para3)
#define LSA_IDX_TRACE_04_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4) \
	PNTRC_TRACE_04_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4)
#define LSA_IDX_TRACE_05_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5) \
	PNTRC_TRACE_05_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5)
#define LSA_IDX_TRACE_06_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6) \
	PNTRC_TRACE_06_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6)
#define LSA_IDX_TRACE_07_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7) \
	PNTRC_TRACE_07_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7)
#define LSA_IDX_TRACE_08_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8) \
	PNTRC_TRACE_08_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8)
#define LSA_IDX_TRACE_09_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9) \
	PNTRC_TRACE_09_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9)
#define LSA_IDX_TRACE_10_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10) \
	PNTRC_TRACE_10_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10)
#define LSA_IDX_TRACE_11_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11) \
	PNTRC_TRACE_11_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11)
#define LSA_IDX_TRACE_12_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12) \
	PNTRC_TRACE_12_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12)
#define LSA_IDX_TRACE_13_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13) \
	PNTRC_TRACE_13_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13)
#define LSA_IDX_TRACE_14_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14) \
	PNTRC_TRACE_14_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14)
#define LSA_IDX_TRACE_15_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15) \
	PNTRC_TRACE_15_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15)
#define LSA_IDX_TRACE_16_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15, para16) \
	PNTRC_TRACE_16_EXT(subsys, idx, level, module, line, msg, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10, para11, para12, para13, para14, para15, para16)
