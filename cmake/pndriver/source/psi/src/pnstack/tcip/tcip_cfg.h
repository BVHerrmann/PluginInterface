...
#error "TCIP_CFG_COPY_ON_SEND not defined"
#endif
...
#error "TCIP_CFG_MAX_SOCKETS not defined"
    ...
    #define TCIP_CFG_MAXARPS        LSA_MAX((PSI_CFG_MAX_DIAG_TOOLS + ((PSI_MAX_CL_DEVICES + (PSI_MAX_SV_DEVICES * PSI_MAX_SV_IOC_ARS)) * PSI_CFG_MAX_IF_CNT)),32)
...
#define TCIP_CFG_ENABLE_SOCKET_EVENTS 0 /* enable event driven mode (no select) */
