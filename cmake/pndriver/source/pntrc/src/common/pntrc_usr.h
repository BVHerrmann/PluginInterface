...
#ifndef PNTRC_NO_SUB_H // types from pntrc_sub.h/pntrc_sub_autogen.h are not defined
...
#define PNTRC_START_MASK        0x1
#define PNTRC_LOCAL_MASK        0x2
#define PNTRC_LOWER_MASK        0x4
#define PNTRC_SCALER_MASK       0x8
...
#ifndef PNTRC_NO_SUB_H // TRACE_SUBSYS_NUM from pntrc_sub.h/pntrc_sub_autogen.h not defined
...
#define TRACE_MD5_MAGICNUMBER 0x55445544 //header magic value for MD5 checksum structure
...
typedef struct pntrc1_buffer_header_tag
{
	...
	LSA_UINT32                   Options;
	LSA_UINT32		             Flags;
	LSA_UINT32                   TraceMap_MD5isUsed;    // 0: ignore the MD5 values, != 0: MD5 Value is used. Note: Was "Reserved1" in older versions at this place.
    LSA_UINT32                   TraceMap_MD5_1;        //MD5 Value of the TraceMap 1-8,   used if PNTRC_CFG_CHECK_SCANNERINFO is set
    LSA_UINT32                   TraceMap_MD5_2;        //MD5 Value of the TraceMap 9-16,  used if PNTRC_CFG_CHECK_SCANNERINFO is set
    LSA_UINT32                   TraceMap_MD5_3;        //MD5 Value of the TraceMap 17-24, used if PNTRC_CFG_CHECK_SCANNERINFO is set
    LSA_UINT32                   TraceMap_MD5_4;        //MD5 Value of the TraceMap 25-32, used if PNTRC_CFG_CHECK_SCANNERINFO is set
    LSA_UINT32                   Reserved2;             //place holder for future versions.
