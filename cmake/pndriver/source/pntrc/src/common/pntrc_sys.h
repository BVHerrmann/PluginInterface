...
#define PNTRC_TWINBUF_NUMBER    2 // do not change this
...
typedef struct dummy_pntrc_cpu_handle_type {
    ...
    /* Array with pointers to the Tracebuffers of this lower cpu. This is a 3 dimensional array with the 
    (1) own instance plus the lower cpus of this lower cpu ("lowerLowerCpu") [own instance, lowerLowerCpu1, lowerLowerCpu2, ...]    -> 1 + PNTRC_CFG_MAX_LOWER_CPU_CNT
    (2) the category [category 1, category 2, ...]                                                                                  -> PNTRC_MAX_CATEGORY_COUNT
    (3) the two switch buffers                                                                                                      -> 2
    */
...
LSA_VOID PNTRC_UNDO_INIT_TRACE_TIMER(LSA_VOID);
...
LSA_VOID pntrc_service(LSA_VOID);
...
LSA_VOID PNTRC_WRITE_LOCAL_SYNC_TIME(LSA_VOID);
#else
...
/**
 * Fills the array md5 with the values generated by ltrcscanner.
 * Note: The implementation pntrc_get_md5sum_scannerinfo as well as the file 
 * pntrc_checksum.c is generated by the perl script.
 * 
 * @param [in] md5 - array md5[4]. This function will fill this array with values
 * @return LSA_VOID
 */
 ...
 *
 * parameters:     LSA_UINT32  *  ltrc_tracestamp_hi
