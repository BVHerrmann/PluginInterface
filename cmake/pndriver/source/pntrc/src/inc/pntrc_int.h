...
typedef struct pntrc_data_tag
{
    ...
    /* Array with all lower CPUs of this PNTRC instance. The CPU instances are accessed by the index (1...PNTRC_CFG_MAX_LOWER_CPU_CNT), 
    thats why the arrayhas the length 1+PNTRC_CFG_MAX_LOWER_CPU_CNT. Index 0 is not used.
    */
    ...
    LSA_BOOL bStartTraceTimeWritten;
} PNTRC_DATA_TYPE;
