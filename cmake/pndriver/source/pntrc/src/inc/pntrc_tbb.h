...
LSA_EXTERN LSA_VOID pntrc_tbb_init(const PNTRC_INIT_TYPE *pInit);
...
LSA_EXTERN LSA_VOID pntrc_tbb_set_log_levels(const LSA_UINT8* pLogLevels, LSA_USER_ID_TYPE UserID, PNTRC_SYSTEM_CALLBACK_FCT_PTR_TYPE SetLogLevelCB);
...
//LSA_EXTERN LSA_VOID  ltrc_tbb_undo_init (LSA_VOID);
//LTRC_BUFFER_ADMIN_TYPE* ltrc_tbb_buffer_init(LSA_UINT base_address, LSA_UINT32 buff_size);
...
/*=============================================================================
 * function name:  pntrc_tbb_memory_synctime_start
 *
 * function:       Print binary trace entry into the memory buffer
 *
 * parameters:     LTRC_SUBSYS_TYPE subsys:   subsys number
...
/*=============================================================================
 * function name:  pntrc_tbb_memory_synctime_local
 *
 * function:       Print binary trace entry into the memory buffer
 *
 * parameters:     LTRC_SUBSYS_TYPE subsys:   subsys number
...
/*=============================================================================
 * function name:  pntrc_tbb_memory_synctime_lower
 *
 * function:       Print binary trace entry into the memory buffer
 *
 * parameters:     LTRC_SUBSYS_TYPE subsys:   subsys number
...
/*=============================================================================
 * function name:  pntrc_tbb_memory_synctime_scaler
 *
 * function:       Print binary trace entry into the memory buffer
 *
 * parameters:     LTRC_SUBSYS_TYPE subsys:   subsys number
