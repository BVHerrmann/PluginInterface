...
/*--- *PARS_SafeElementMalloc() ----------------------------------------- *PARS_SafeElementMalloc() ---*\
|                                                                                                      |
|    Group / Interface:                                                                                |
|        Memory Management                                                                             |
|                                                                                                      |
|    Description:                                                                                      |
|            Used for memory allocation needed for xml nodes and attributes. Allocation is             |
|            done from memory pool.                                                                    |
|                                                                                                      |
|                                                                                                      |
|    Parameters:                                                                                       |
|        a_dwSize            [  in ]   Size of the requested memory block                              |
|                                                                                                      |
|                                                                                                      |
|    Return Value:                                                                                     |
|        PARS_LPVOID :       !=PNIO_NULL The Memory Block, PNIO_NULL: Out of Memory                    |
|                                                                                                      |
|    Side Effects:                                                                                     |
|        none                                                                                          |
|                                                                                                      |
\*--- *PARS_SafeElementMalloc() ------------------------------------------*PARS_SafeElementMalloc() ---*/
PARS_LPVOID DLLCALL PARS_SafeElementMalloc( /*  in */ PARS_DWORD     a_dwSize )
{
    return pnd_allocateFromPool(a_dwSize);
}
...
/*--- *PARS_SafeElementFree() ----------------------------------------- *PARS_SafeElementFree() -------*\
|                                                                                                      |
|    Group / Interface:                                                                                |
|        Memory Management                                                                             |
|                                                                                                      |
|    Description:                                                                                      |
|            Frees memory pool used for xml node and attribute allocation.                             |
|                                                                                                      |
|    Parameters:                                                                                       |
|                                                                                                      |
|    Return Value:                                                                                     |
...
|                                                                                                      |
\*--- *PARS_SafeElementFree() ----------------------------------------------*PARS_SafeElementFree() ---*/
PARS_VOID DLLCALL PARS_SafeElementFree()
{
    pnd_freePool();        
}
/*****************************************************************************/
