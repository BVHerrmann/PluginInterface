...
FileSysServiceInterface PARS_XML_g_File;
FileSysServiceInterface*        PARS_XML_g_pFile        = &PARS_XML_g_File;   /* file system services */
...
PARS_RESULT  /* DLL_EXPORT */ /* MG */  PARS_XML_InitializeStandaloneXMLService( /*  in */ XML_T_extern_SMemMalloc      a_fpMalloc,
                                                                             ...
                                                                             /*  in */ XML_T_extern_SElementMalloc  a_fpElementMalloc,
                                                                             /*  in */ XML_T_extern_SElementFree    a_fpElementFree,
...
RETURN_INIT(MWE_FAC_XML_SERVICE, "PARS_XML_InitializeStandaloneXMLService");
    ...
    XML_extern_SElementMalloc = a_fpElementMalloc;
    XML_extern_SElementFree   = a_fpElementFree;
#endif
...
XML_T_extern_SElementMalloc XML_extern_SElementMalloc = PARS_NULL;
XML_T_extern_SElementFree   XML_extern_SElementFree   = PARS_NULL;
XML_T_extern_SMemMalloc     XML_extern_SMemMalloc = PARS_NULL;
XML_T_extern_SMemFree       XML_extern_SMemFree   = PARS_NULL;
MemServiceInterface         PARS_XML_g_pMem2;		
                                   ...
                                   /*  in */ PARS_BOOL      a_bIgnoreWhiteSpace)
{
	...
	if( nStrLen > 0 &&  0 != a_strValue && 0 != a_posActual && ((PARS_INT)strlen(a_strValue)) > nStrLen )
	{
...
PARS_RESULT PARS_XML_NewAttribute ( /* out */ PARS_XML_PT_internalAttributes*   a_pattrValue )
{
    ...
    *a_pattrValue = (PARS_XML_PT_internalAttributes) XML_extern_SElementMalloc(sizeof(PARS_XML_T_internalAttributes));
#endif /* PARS_USE_MEM_POOL */
...
#else /* PARS_USE_MEM_POOL */
    ndeNewNode = (PARS_XML_PT_internalNode) XML_extern_SElementMalloc(sizeof(PARS_XML_T_internalNode));
#endif /* PARS_USE_MEM_POOL */
...
PARS_RESULT PARS_XML_DeleteAllNodes ( /*  in */ PARS_XML_PT_internalNode    a_ndeNode)
{
    ...
    while (tmpNode)
    {
        ...
        {
            XML_extern_SElementFree();
            tmpNode = PARS_NULL;
        }
        else
        {
            tmpNode = tmpNode->p_ndeNextNeighbour;    
        }        
        #if PARS_USE_MEM_POOL
            if( PARS_XML_g_pMem != PARS_NULL)
            {
...
PARS_RESULT DLLCALL PARS_Generate_Rema_XML_Buffer(PARS_PND_REMA_DATA_TYPE rema, PARS_LPSTR** remaData, PARS_DWORD* remaDataLength)
{
	...
	PARS_XML_InitializeStandaloneXMLService( PARS_SafeMalloc, PARS_SafeFree, PARS_SafeElementMalloc, PARS_SafeElementFree, &pXMLService);
