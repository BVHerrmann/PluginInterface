                                               ...
                                               /* out */ PARS_LPDWORD         a_pdwLength)
{
    ...
    {
        strBuff[5] = ':';
		CHECK_NULL_PARAMETER((strBuff + 6))
		CHECK_NULL_PARAMETER(a_strNamespace)
...
PARS_VOID  (XmlWrite)	( /*  in */ const PARS_LPVOID  a_pBuffer)
{
	...
	sprintf(xmlBuffer+xmlBufferLength, "%s", (char*)a_pBuffer);
...
{
	xmlBufferLength = 0;
	xmlBuffer = (LSA_CHAR*)xml_malloc(XML_MAX_BUFFER_SIZE);
}
