...
{
	LSA_INT16 n = 0, count, sign = 1, str_len = 0;
	LSA_UINT16 multiplier = 0;
    LSA_INT16 digit[10];      
    LSA_CHAR *str=rawstr;
    LSA_UINT32 uValue = 0;  
    ...
    while(n < count) 
    {   
		/*lint -e{737} loss of sign in promotion from int to unigned int */
...
///
///////////////////////////////////////////////////////////////////////////////
LSA_UINT8 xml_hex_string_to_byte_array (const LSA_CHAR *str, LSA_UINT8 *byte_array, LSA_UINT32 nr_of_bytes)
{
    LSA_UINT16 i = 0;
    LSA_CHAR byte[3] = {0};
    LSA_UINT32 value = 0;
