#ifndef PND_PSI_CFG_PLF_BASIC_LINUX_HOST_OBSD_H
#define PND_PSI_CFG_PLF_BASIC_LINUX_HOST_OBSD_H
...
/*                                                                           */
/*  F i l e               &F: pnd_psi_cfg_plf_basic_linux_host_obsd.h   :F&  */
/*                                                                           */
...
/*        Platform settings                                                  */
/*===========================================================================*/
/* EPS_PLATFORM_PNDRIVER and EPS_PLF_LINUX_X86 are defined in <eps_plf_types.h> */
...
#define PND_CFG_IOXS_REQUIRED 0 // DiscardIOXS is not supported
#define PND_CFG_BASIC_VARIANT
#define PND_CFG_ISO_SUPPORT
...
#define PSI_CFG_MAX_IF_CNT       4/* Maximum number of PNIO interfaces of all EDDs integrated     */
#define PSI_CFG_MAX_PORT_CNT     4 /* Maximum number of ports supported by EDD API services        */
#define PSI_CFG_MAX_EDDI_DEVICES PSI_CFG_MAX_HD_CNT
...
#define PSI_CFG_MAX_SOCK_APP_CHANNELS           2 /* Maximum number of user application sock channels, Values (1..8) */ // TODO: Setting 0 generates compile error!
...
#define PSI_MAX_CL_DEVICES     128       // Max devices for create client
#define PSI_MAX_CL_IRT_DEVICES 32         // Max IRT devices
...
#define EPS_CFG_USE_INTERNAL_MAC_FUNCTIONS

#define EDDI_CFG_SET_ERTEC_VERSION_EXTERN
#define PSI_CFG_EDDI_CFG_SOC
#define PSI_CFG_EDDI_CFG_APPLSYNC_SEPARATE
#define EDDI_ISO_CFG_PASS_INTREG

#define PSI_CFG_TCIP_STACK_OPEN_BSD           1
#define PSI_CFG_TCIP_CFG_COPY_ON_SEND         (PSI_TCIP_CFG_COPY_ON_SEND)
#define PSI_CFG_HIF_CFG_COMPILE_SERIALIZATION 1                       
#define PSI_CFG_HIF_CFG_MAX_LD_INSTANCES      2                       // anzahl der USER LDs  *2
#define PSI_CFG_HIF_CFG_MAX_HD_INSTANCES      (PSI_CFG_MAX_HD_CNT*2)  // ableiten aus MAX HD *2 fuer Upper/lower
...
#endif  /* of PND_PSI_CFG_PLF_BASIC_LINUX_HOST_OBSD_H */
