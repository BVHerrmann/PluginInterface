#ifndef PND_PSI_CFG_PLF_LINUX_SOC1_OBSD_H
#define PND_PSI_CFG_PLF_LINUX_SOC1_OBSD_H
...
/*                                                                           */
/*  F i l e               &F: pnd_psi_cfg_plf_linux_soc1_obsd.h         :F&  */
/*                                                                           */
...
// TODO: Added for V6.0...02.00.65 integration
/*------------------------------------------------------------------------------
For EPS-INTERNAL use only! 
This define deactivates the out macro EPS_APP_GET_MAC_ADR
and allows us to use the internal implementations to get the mac adr
------------------------------------------------------------------------------*/
...
#if EPS_CFG_USE_LD
#define EDDI_CFG_SII_USE_SPECIAL_EOI    4999    //100 µs on IRTE Rev 7
#endif
...
#endif  /* of PND_PSI_CFG_PLF_LINUX_SOC1_OBSD_H */
