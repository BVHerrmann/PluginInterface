#ifndef PNDRIVER_PNTRC_SUB_H
#define PNDRIVER_PNTRC_SUB_H
...
// Note: If no text is compiled, the EXT_ macros throw an unused arg warning for msg. 
// PNTRC_SUPRESS_WARNING_TEXT is empty if msg is used and mapped to LSA_UNUSED_ARG if 
// the msg is not used.
#if (PNTRC_CFG_COMPILE_TEXT == 1)
#define PNTRC_COMPILE_TEXT              msg,
#define PNTRC_COMPILE_TEXT_TYPE         LSA_CHAR*,
#define PNTRC_SUPRESS_WARNING_TEXT  
#else
...
struct pntrc_entry_fcts
{
    ...
    LSA_BOOL LSA_FCT_PTR(, entrysynctime_start)
        (LTRC_SUBSYS_TYPE, PNTRC_LEVEL_TYPE, LSA_UINT32, PNTRC_COMPILE_MODULE_ID_TYPE PNTRC_COMPILE_FILE_TYPE PNTRC_COMPILE_LINE_TYPE PNTRC_COMPILE_TEXT_TYPE LSA_UINT32, LSA_UINT32,
            LSA_UINT32);

    LSA_BOOL LSA_FCT_PTR(, entrysynctime_local)
        (LTRC_SUBSYS_TYPE, PNTRC_LEVEL_TYPE, LSA_UINT32, PNTRC_COMPILE_MODULE_ID_TYPE PNTRC_COMPILE_FILE_TYPE PNTRC_COMPILE_LINE_TYPE PNTRC_COMPILE_TEXT_TYPE LSA_UINT32, LSA_UINT32,
            LSA_UINT32);

    LSA_BOOL LSA_FCT_PTR(, entrysynctime_lower)
        (LTRC_SUBSYS_TYPE, PNTRC_LEVEL_TYPE, LSA_UINT32, PNTRC_COMPILE_MODULE_ID_TYPE PNTRC_COMPILE_FILE_TYPE PNTRC_COMPILE_LINE_TYPE PNTRC_COMPILE_TEXT_TYPE LSA_UINT32, LSA_UINT32,
            LSA_UINT32, LSA_UINT32);

    LSA_BOOL LSA_FCT_PTR(, entrysynctime_scaler)
        (LTRC_SUBSYS_TYPE, PNTRC_LEVEL_TYPE, LSA_UINT32, PNTRC_COMPILE_MODULE_ID_TYPE PNTRC_COMPILE_FILE_TYPE PNTRC_COMPILE_LINE_TYPE PNTRC_COMPILE_TEXT_TYPE LSA_UINT32, LSA_UINT32,
            LSA_UINT32);
};
...
#endif // (PNTRC_CFG_COMPILE_TEXT == 1)
