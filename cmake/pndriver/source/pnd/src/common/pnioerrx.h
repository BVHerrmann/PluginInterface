...
/**
 * \file pnioerrx.h 
 * \brief Error codes for IO-Base user interface  
 */

/**
 * \defgroup grpSuccess Success Codes
 * @{
 */
...
/* warnings */
/**
 * \defgroup grpWarnings Warning Codes
 * @{
 */
...
#define PNIO_WARN_NO_DECENTRALIOSYSTEM      0x00000013  /**< no decentral io system is found in the configuration */
/** @} */

/* wrong functions calls, parameter errors */
/**
 * \defgroup grpErrorCodes Error Codes
 * - \ref grpWrongFuncs
 * - \ref grpInstErrors
 * - \ref grpOtherErrors
 * - \ref grpComp
 ...
 */
 ...
 /**
 * \defgroup grpWrongFuncs Wrong Functions Calls, Parameter Errors
 * @{
 */
...
#define PNIO_ERR_PRM_IP                     0x00000118  /**< parameter IP has no valid value */
#define PNIO_ERR_PRM_NOS                    0x00000119  /**< parameter NoS has no valid value */
#define PNIO_ERR_PRM_NOS_LEN                0x0000011A  /**< parameter length is wrong */
/** @} */

/* instance errors */
 /**
 * \defgroup grpInstErrors Instance Errors
 * @{
 */
...
#define PNIO_ERR_RETRY                      0x00000208  /**< pnio stack not available, try again later */
/** @} */

/* other errors */
/**
 * \defgroup grpOtherErrors Other Errors
 * @{
 */
...
/**
 * \defgroup grpComp Spelling Error, Compatibility Hack 
 * @{
 */
...
#define PNIO_ERR_NO_RESET_VERIFICATION          0x0000031C  /**< reset request was sent to firmware, but firmware rut up can't be verified */
#define PNIO_ERR_SET_IP_NOS_NOT_ALLOWED         0x0000031D  /**< setting IP and/or NoS is not allowed */
#define PNIO_ERR_INVALID_REMA		            0x0000031E  /**< rema data is not valid */
#define PNIO_ERR_NOT_REENTERABLE                0x0000031F  /**< the function is not reenterable */
#define PNIO_ERR_INVALID_STATION                0x00000320  /**< station not configured as optional */
#define PNIO_ERR_INVALID_PORT                   0x00000321  /**< port not configured as programmable peer */
#define PNIO_ERR_NO_ADAPTER_FOUND               0x00000322  /**< no ethernet adapter found */
#define PNIO_ERR_ACCESS_DENIED                  0x00000323  /**< access denied */
#define PNIO_ERR_START_ASYNCBUF_THREAD_FAILED   0x00000XXX/**< failed to start thread for handling asynchronous buffer exchange */
#define PNIO_ERR_PPA_HOST_ATTACH_FAILED         0x00000XXX  /**< pnio lib in host could not attach to PPA regsiter set */
#define PNIO_ERR_NO_CALLBACK_REGISTERED         0x00000XXX  /**< no callback registered */
#define PNIO_ERR_ASYNCBUF_TOGGLE_TIMEOUT        0x00000XXX  /**< update time is out of expected range */
#define PNIO_ERR_RESTART_HOST                   0x00000XXX  /**< update of firmware requires a host restart*/
/** @} */

/* internal error */
/**
 * \defgroup grpInternalErr Internal Error 
 * @{
 */
