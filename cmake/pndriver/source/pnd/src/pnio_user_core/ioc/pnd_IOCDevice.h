...
private:
    ...
    LSA_BOOL          m_isIrt;			// Device is configured as IRT or not.
...
public:
    ...
    LSA_UINT      GetSubslots( UserNodeVector &list );
    LSA_VOID     SetEddHwType( LSA_UINT32 hwType );
    LSA_VOID     ResetSubslots( LSA_UINT16 state );
	LSA_BOOL     GetDeviceState() const;
    LSA_VOID     SetInitialDeviceState();
	LSA_VOID     GetDeviceDiagState( LSA_UINT16 *error_cause, LSA_UINT8 *reason_code, LSA_UINT8 *additional_info ) const;
	LSA_VOID     SetDeviceDiagState( LSA_UINT16 error_cause, LSA_UINT8 reason_code, const LSA_UINT8 *additional_info );
	LSA_BOOL     IsIrt() const;
    ...
    LSA_UINT16 GetVendorID() const;
    LSA_UINT16 GetDeviceID() const;
    LSA_UINT16 GetInstanceID() const;
...
private:
    ...
    PND_IO_ADDR_PTR_TYPE createAddressList( UserNodeVector &sublist, LSA_BOOL isProvider ) const;
