...
//	CM_UPPER_RQB_PTR_TYPE  ReStoreAlarmRqb(PND_RQB_PTR_TYPE pnd_rqb);
	...
	PND_IOC_MODE_TYPE GetMode( LSA_VOID ) const;
    ...
    LSA_VOID AllocateLinkList();
    LSA_VOID FreeLinkList();
...
protected:
    ...
    static LSA_VOID AllocateLinkListDone(LSA_VOID* p_inst, LSA_VOID* p_rb);
    static LSA_VOID FreeLinkListDone(LSA_VOID* p_inst, LSA_VOID* p_rb);
