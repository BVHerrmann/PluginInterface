#ifndef PND_IOC_SLOT_H
#define PND_IOC_SLOT_H
/*****************************************************************************/
...
/////////////////////////////////////////////////////////////////////////////
// CIOCSlot  storage class for an IOC subslot (shadow of device subslot)
/////////////////////////////////////////////////////////////////////////////

class CIOCSlot : public CUserNode
{
    // Attributes
private:
...
public:
    CIOCSlot( LSA_UINT32 api, LSA_UINT16 slot, LSA_UINT16 subslot_ladd, PND_HANDLE_PTR_TYPE pHandle, CUserNode* parent );
    virtual ~CIOCSlot();
