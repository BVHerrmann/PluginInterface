...
LSA_UINT16 CIOCAr::GetSessionKey() const
{
	return ( m_sessionKey );
}

/*----------------------------------------------------------------------------*/
PND_IOC_AR_STATE_TYPE CIOCAr::GetArState() const
{
	return ( m_arState );
}
...
/*----------------------------------------------------------------------------*/
PND_AR_DS_TYPE CIOCAr::GetArDataState() const
{
	return ( m_arDS );
}

/*----------------------------------------------------------------------------*/
LSA_UINT16 CIOCAr::GetArType() const
{
	return ( m_type );
}

/*----------------------------------------------------------------------------*/
LSA_UINT16 CIOCAr::GetArNumber() const
{
	return ( m_arNr );
}
...
/*----------------------------------------------------------------------------*/
/*lint -e{818} Pointer parameter 'p_uuid' could be declared as pointing to const */
...
/*----------------------------------------------------------------------------*/
LSA_BOOL CIOCAr::IsINDATA() const
{
...
/*----------------------------------------------------------------------------*/
LSA_BOOL CIOCAr::IsPassivate() const
{
...
/*----------------------------------------------------------------------------*/
LSA_BOOL CIOCAr::IsRecordReadAllowed() const
{
