...
private:
    ...
    LSA_UINT8   m_pdevProperties;     // see CM_PDEV_PROP_
    LSA_UINT8   m_im0Bits;            // 0 
...
public:
	...
	LSA_UINT16 GetSubslotNr() const;
	LSA_UINT16 GetSubslotLogAddr() const;
	LSA_UINT32 GetSlotIdent() const;
	LSA_UINT32 GetSubslotIdent() const;
    LSA_UINT8  GetPdevProperties() const;
    LSA_UINT8  GetIm0Bits() const;

	PND_SYNC_STATE_TYPE GetSyncState() const;
	...
	LSA_BOOL IsMapped() const;
	LSA_BOOL IsLinkUp() const;
