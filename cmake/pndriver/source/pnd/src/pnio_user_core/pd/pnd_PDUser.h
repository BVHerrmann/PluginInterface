...
public:
    ...
    LSA_VOID SendPDSyncInfo(LSA_UINT16 portID);
    LSA_VOID SendRxLocalTransferEndNs(LSA_UINT32 rxLocalTransferEndNs) const;
	...
	LSA_VOID PrmEnd();
	LSA_VOID InterfaceOpen( PND_RQB_PTR_TYPE p_rb ) const;
	LSA_VOID InterfaceClose( PND_RQB_PTR_TYPE p_rb );
	LSA_VOID AlarmProvide( PND_RQB_PTR_TYPE p_rb );
	LSA_VOID AlarmIndication( LSA_VOID * p_rb ) const;
