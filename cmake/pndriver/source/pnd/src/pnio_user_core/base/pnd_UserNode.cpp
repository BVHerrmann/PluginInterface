...
LSA_VOID CUserNode::AddNode( UserNodeMap &userNodeMap, CUserNode* node ) const
{
	PND_ASSERT( node != 0 );
...
/*---------------------------------------------------------------------------*/
CUserNode* CUserNode::RemoveNode( UserNodeMap &userNodeMap, CUserNode* node ) const
{
	PND_ASSERT( node != 0 );
...
LSA_VOID CUserNode::deleteMap( UserNodeMap &userNodeMap ) const
{
	UserNodeMap::iterator mapIter;
...
/*---------------------------------------------------------------------------*/
LSA_VOID CUserNode::deleteList( UserNodeVector &list ) const
{
	// Free CUserNode elements in Object list
	LSA_UINT len = list.size();

	for ( LSA_UINT lvi = 0; lvi < len; lvi++ )
	{
...
/*---------------------------------------------------------------------------*/
CUserNode* CUserNode::getSubNode( UserNodeMap &userNodeMap, LSA_UINT16 key ) const
{
	CUserNode *node = 0;
...
/*---------------------------------------------------------------------------*/
CUserNode* CUserNode::getSubNode( UserNodeMap &userNodeMap, LSA_UINT32 key ) const
{
	CUserNode *node = 0;
...
/*---------------------------------------------------------------------------*/
CUserNode* CUserNode::getSubNode( UserNodeMap &userNodeMap, string key ) const
{
	CUserNode *node = 0;
...
/*---------------------------------------------------------------------------*/
LSA_UINT CUserNode::getNodeList( UserNodeMap &userNodeMap, UserNodeVector &list ) const
{
	UserNodeMap::iterator mapIter;
...
/*---------------------------------------------------------------------------*/
/*lint -e{1536} Expoisng low access member 'CUserNode::m_pndHandle' */
PND_HANDLE_PTR_TYPE CUserNode::GetPndHandle()
{
    return &m_pndHandle;
}
