...
LSA_VOID_PTR_TYPE pnd_oha_alloc_rqb( LSA_OPCODE_TYPE opcode, LSA_HANDLE_TYPE handle, PND_HANDLE_PTR_TYPE pnd_sys )
{
	...
	OHA_ALLOC_UPPER_RQB_LOCAL((LSA_VOID_PTR_TYPE *)&pRQB, sizeof(*pRQB));
	PND_ASSERT(pRQB);
	...
	case OHA_OPC_LLDP_READ_ELEMENT:
		{
			OHA_ALLOC_UPPER_MEM((LSA_VOID**)&pRQB->args.LldpElem.pElements, dummy_user_id, sizeof(OHA_LLDP_OPTION_TYPE) * PND_OHA_LLDP_LIST_ENTRIES, &psi_sys );
			PND_ASSERT(pRQB->args.LldpElem.pElements);
			pnd_memset(pRQB->args.LldpElem.pElements, 0, sizeof(OHA_LLDP_OPTION_TYPE) * PND_OHA_LLDP_LIST_ENTRIES);
	...
	case OHA_OPC_LLDP_READ_OPTIONS:
		{
			OHA_ALLOC_UPPER_MEM((LSA_VOID**)&pRQB->args.LldpOptions.pElements, dummy_user_id, sizeof(OHA_LLDP_OPTION_TYPE) * PND_OHA_LLDP_LIST_ENTRIES, &psi_sys );
			PND_ASSERT(pRQB->args.LldpOptions.pElements);
			pnd_memset(pRQB->args.LldpOptions.pElements, 0, sizeof(OHA_LLDP_OPTION_TYPE) * PND_OHA_LLDP_LIST_ENTRIES);
	...
	case OHA_OPC_READ_QUERY_ELEMENTS:
		{
			OHA_ALLOC_UPPER_MEM((LSA_VOID**)&pRQB->args.QueryElem.pElements, dummy_user_id, sizeof(OHA_LLDP_OPTION_TYPE) * PND_OHA_LLDP_LIST_ENTRIES, &psi_sys );
