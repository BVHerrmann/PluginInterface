#ifndef EDDI_CRT_PHASE_RX_H     //reinclude-protection
#define EDDI_CRT_PHASE_RX_H
...
/*                                                                           */
/*  F i l e               &F: eddi_crt_phase_rx.h                       :F&  */
/*                                                                           */
...
// ATTENTION: This enum is related to FunctionTable CrtPhaseRxFctTable !!
typedef enum _EDDI_CRT_PHASE_RX_STATE
{
    EDDI_CRT_PHASE_RX_STS_NO  = 0,
    EDDI_CRT_PHASE_RX_STS_IRT = 1

} EDDI_CRT_PHASE_RX_STATE;

typedef enum _EDDI_CRT_PHASE_RX_EVENT
{
    EDDI_CRT_PHASE_RX_EVT_IRT_ACTIVATE_SHIFT,
    EDDI_CRT_PHASE_RX_EVT_IRT_DEACTIVATE_UNSHIFT,
    EDDI_CRT_PHASE_RX_EVT_IRT_ACTIVATE_SHIFT_FINISH,
    EDDI_CRT_PHASE_RX_EVT_IRT_DEACTIVATE_UNSHIFT_FINISH

} EDDI_CRT_PHASE_RX_EVENT;

typedef struct _EDDI_CRT_PHASE_RX_MACHINE
{
    EDDI_CRT_PHASE_RX_STATE                           State;
    ...
    LSA_UINT32                                        IrtStartTimeRcvRegAdr;  // IRTE-Register-Adress
    ...
    //Finish-Event:
    EDDI_CRT_PHASE_RX_EVENT                           FinishEvent;            // Event to be used to finish a transition.
    #endif

    LSA_UINT32                                        RxFcwSolTimeMac10Ns;    // time is already corrected by Preframe-Send-Delay!
                                                                              // this parameter is only used for FCWs!

} EDDI_CRT_PHASE_RX_MACHINE;

#ifdef __cplusplus //If C++ - compiler: End of C linkage
}
#endif

#endif //EDDI_CRT_PHASE_RX_H


/*****************************************************************************/
/*  end of file eddi_crt_phase_rx.h                                          */
/*****************************************************************************/
