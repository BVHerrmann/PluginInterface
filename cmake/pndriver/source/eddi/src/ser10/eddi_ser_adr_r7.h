#ifndef EDDI_SER_ADR_R7_H       //reinclude-protection
#define EDDI_SER_ADR_R7_H
...
/*                                                                           */
/*                       internal Register of SER10 - Rev7                   */
/*                                                                           */
/*****************************************************************************/
/*                                                                           */
/*  H i s t o r y :                                                          */
...
//#define GROUP_NUMBER        0x0001604c

#define TIMER_SCOREB_BASE     0x00016050
#define TIMER_SCOREB_ENTRIES  0x00016054
#define PS_SCOREB_BASE_0      0x00016058
#define PS_SCOREB_BASE_1      0x0001605c
#define TM_LIST_BASE_ADR      0x00016060
//#define TM_LIST_SIZE        0x00016064
#define FC_MASK               0x00016068
#define HOL_MASK_P0           0x0001606c
#define HOL_MASK_P1           0x00016070

#define HOL_MASK_P2           0x00016074
//#define HOL_MASK_P3         0x00016078
...
//#define LOW_WATER_STATUS    0x00016420

#define NRT_FCW_COUNT         0x00016424
#define NRT_DB_COUNT          0x00016428
#define SRT_FCW_COUNT         0x0001642c
#define HOL_COUNT_CHA_SS0     0x00016430
#define HOL_COUNT_CHA_SS1     0x00016434
//#define LIST_STATUS_CHA     0x00016438
#define HOL_COUNT_CHB_SS0     0x0001643c
#define HOL_COUNT_CHB_SS1     0x00016440
//#define LIST_STATUS_CHB     0x00016444
//#define HOL_COUNT_P0        0x00016448
#define LIST_STATUS_P0        0x0001644c
//#define HOL_COUNT_P1        0x00016450
#define LIST_STATUS_P1        0x00016454
//#define HOL_COUNT_P2        0x00016458
#define LIST_STATUS_P2        0x0001645c
//#define HOL_COUNT_P3        0x00016460
//#define LIST_STATUS_P3      0x00016464
...
#define IP_Address0         0x19024
//#define IP_Address1       0x19028
//#define IP_Address2       0x1902c
//#define IP_Address3       0x19030
#define IRTE_R7_IP_TTL      0x19034
#define UDP_PNIO_PORT0      0x19038
//#define UDP_PNIO_PORT1    0x1903c
//#define UDP_PNIO_PORT2    0x19040
//#define UDP_PNIO_PORT3    0x19044

#define IRT_CTRL_BASE_ADR   0x00019048
#define NRT_CTRL_BASE_ADR   0x0001904c
#define FREE_CTRL_BASE_ADR  0x00019050
#define ACW_BASE_ADR        0x00019054
#define ACW_MASK            0x00019058
#define SWI_CTRL            0x0001905c
#define MIN_IDLE_TIME       0x00019060
#define MAC_EMPTY_COUNT     0x00019064
#define NRT_TRANS_CTRL      0x00019068
#define NRT_SAFETY_MARGIN   0x0001906c
#if defined (EDDI_CFG_MIRROR_MODE_INCLUDE)
#define MONITOR_CTRL        0x00019070
#endif //end of EDDI_CFG_MONITOR_MODE_INCLUDE
#define STAT_CTRL_BASE_ADR  0x00019074
#define SWITCH_SETUP_MODE   0x00019078

#define IO_CONTROL_DELAY    0x00019084

#define FILTER_CTRL_BASE    0x0001907c
//#define SWITCH_CT_DELAY     0x00019080

#define SWI_VERSION         0x00019400
#define SWI_STATUS          0x00019404
//#define ACTIVITY_STATUS   0x00019408

//#define ROUTER_MAC_ADR_31_0    0x0001940c
//#define ROUTER_MAC_ADR_47_32   0x00019410
...
#endif //EDDI_SER_ADR_R7_H


/*****************************************************************************/
/*  end of file eddi_ser_adr_r7.h                                            */
/*****************************************************************************/
