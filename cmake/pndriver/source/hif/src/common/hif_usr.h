...
#define HIF_OPC_INTERNAL_POLL      20 // used for the internal ping pong mechanism between low prio thread and normal prio thread
...
#define HIF_CPLD_GLO_APP_IOH_USER_CH             24 /* User Application Channel */
#define HIF_CPLD_GLO_APP_DNS_USER_CH             28 /* User Application Channel */
#define HIF_CPLD_GLO_APP_HSA_USER_CH             31 /* User Application Channel */
#define HIF_CPLD_GLO_APP_SOCKAPP_USER_CH         32 /* User Application Channel */
...
#define HIF_CPLD_IF_APP_IOM_CMMC_USER_CH         22 /* User Application Channel */
...
#define HIF_CPLD_GLO_LD_EPS                      29
#define HIF_CPLD_IF_HD_EPS                       30
...
#define HIF_CPHD_IF_HD_EPS                       35
#define HIF_CPHD_IF_SYS_HSA_EDD                  36
...
/**
* HD input configuration for one HD
*/
typedef struct hif_hd_input_tag
{
...
/**
 * \brief open a communication channel
 *   
 * RQB-parameters:
 *     RQB-header:
 ...
 *     
 * @param [in] upper_rqb_ptr    - pointer to the RQB
 */
...
/**
 * \brief send a request to a communication channel
 * 
 * RQB-parameters:
 *     RQB-header:
...
/**
* \brief Calls hif_poll in _low prio_ context. 
* 
* This function is triggered within HIF_OPC_POLL by HIF. The system adaptation does a context switch to a low prio thread and calls this function.
* 
* hif_poll itself will send a RQB to the normal prio thread with the OPC HIF_OPC_POLL (they call each other -> ping pong). 
* Since this function is executed in low prio context, the system load determines how often this function is executed.
* 
* @param [in] ptr_upper_rqb - Internal poll RQB
*/
LSA_VOID  hif_internal_poll(
    HIF_RQB_PTR_TYPE  upper_rqb_ptr
);
