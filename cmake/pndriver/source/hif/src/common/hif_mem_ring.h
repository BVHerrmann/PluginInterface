 ...
 */
extern LSA_VOID          hif_mem_ring_free_from_pool(LSA_VOID_PTR_TYPE startPtr, LSA_VOID_PTR_TYPE endPtr, LSA_VOID_PTR_TYPE hif_mem_ring_pool_ptr, LSA_UINT32 block_count);
/**
 ...
 */
extern LSA_VOID          hif_mem_ring_pool_free(LSA_VOID_PTR_TYPE startPtr, LSA_VOID_PTR_TYPE endPtr, LSA_INT pool, LSA_UINT32 block_count);
