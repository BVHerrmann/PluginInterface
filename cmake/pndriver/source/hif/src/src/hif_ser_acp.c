...
/*  HASH-VALUE: GV4rxgJY6s8Gw8rwWOaR3nJwZJ30jb9PphjlR1F2UH8=                 */
/*****************************************************************************/
    ...
    LSA_UINT32*    pSerRqbLen )
{
    ...
    if (opcode==ACP_OPC_OPEN_CHANNEL)
    {
        ...
        rqb_size+=HIF_SER_SIZEOF(4);        /* "args" pointer itself */
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,ptr_rqb_src->args);        /* pointer info itself */
    ...
    if (opcode==ACP_OPC_OPEN_CHANNEL)
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->args)) /*#14*/
        {
            ...
            HIF_FREE_LOCAL_MEMORY(&freeRes, ptr_rqb_src->args, LSA_COMP_ID_ACP, HIF_MEM_TYPE_RQB);
        ...
        freeRes = LSA_RET_ERR_RESOURCE; /* preset negative */
        HIF_FREE_LOCAL_MEMORY(&freeRes, (LSA_UINT8*)ptr_rqb_src-HIF_SER_SIZEOF(4), LSA_COMP_ID_ACP, HIF_MEM_TYPE_RQB);
        if (freeRes != LSA_RET_OK)
        {
            return HIF_ERR_RESOURCE;
        }
        ...
        LSA_VOID** ppRqbDest )
{
    ...
    {
        HIF_PROGRAM_TRACE_02(0,LSA_TRACE_LEVEL_FATAL,"hif_acp_deserialize_upper(). RQB-Opcode:0x%x is not valid! shm_addr(0x%08x)", opcode, ptr_rqb_src);
        HIF_FATAL(0);
    }
        ...
        LSA_VOID** ppRqbDest )
{
    ...
    if (opcode==ACP_OPC_OPEN_CHANNEL)
    {
        ...
        HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb, rqb_size, LSA_COMP_ID_ACP, HIF_MEM_TYPE_RQB);
        ...
        else
        {
            ...
            new_rqb=(ACP_RQB_TYPE*)HIF_CAST_TO_VOID_PTR((LSA_UINT8*)new_rqb+HIF_SER_SIZEOF(4));                                     /* real lower rqb src without orig. upper RQB pointer */
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "args" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->args, sizeof(*new_rqb->args), LSA_COMP_ID_ACP, HIF_MEM_TYPE_RQB );
    ...
    {
        HIF_PROGRAM_TRACE_02(0,LSA_TRACE_LEVEL_FATAL,"hif_acp_deserialize_lower(). RQB-Opcode:0x%x is not valid! shm_addr(0x%08x)", opcode, ptr_rqb_src);
        HIF_FATAL(0);
    }
