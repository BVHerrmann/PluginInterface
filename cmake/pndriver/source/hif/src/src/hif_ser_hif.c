...
/*  HASH-VALUE: D3B68eEM6GwlgFIAixNN2Xkbm3QWBAy/8iPLQ7b/nTY=                 */
/*****************************************************************************/
    ...
    LSA_UINT32*    pSerRqbLen )
{
        ...
        ||(opcode==HIF_OPC_HD_LOWER_OPEN))
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        HIF_FREE_LOCAL_MEMORY(&freeRes, (LSA_UINT8*)ptr_rqb_src-HIF_SER_SIZEOF(4), LSA_COMP_ID_HIF, HIF_MEM_TYPE_RQB);
        ...
        LSA_VOID** ppRqbDest )
{
    ...
    else if (opcode==HIF_OPC_LD_UPPER_OPEN)
    {
        ...
        HIF_SER_RESPONSE_SHMTH(&response,(LSA_UINT32**)&help_ptr);                /* _response */
        HIF_RQB_SET_RESPONSE(new_rqb,response);                                /* _response */
        HIF_SER_COPY_SHMTH_32(&new_rqb->args.dev_ld_open.hd_count,(LSA_UINT32**)&help_ptr);        /* hd_count */
        for(i=0;i<new_rqb->args.dev_ld_open.hd_count;i++)                        /* hd_args*/
        {
            HIF_SER_COPY_SHMTH_16(&new_rqb->args.dev_ld_open.hd_args[i].hd_id,(LSA_UINT32**)&help_ptr);            /* hd_id */
        }
    }
    else if (opcode==HIF_OPC_HD_UPPER_OPEN)
    {
        ...
        HIF_SER_RESPONSE_SHMTH(&response,(LSA_UINT32**)&help_ptr);                /* _response */
        HIF_RQB_SET_RESPONSE(new_rqb,response);                                /* _response */
        HIF_SER_COPY_SHMTH_16(&new_rqb->args.dev_hd_open.hd_args.hd_id,(LSA_UINT32**)&help_ptr);        /* hd_id */
    }
    else
    {
        HIF_PROGRAM_TRACE_02(0,LSA_TRACE_LEVEL_FATAL,"hif_hif_deserialize_upper(). RQB-Opcode:0x%x is not valid! shm_addr(0x%08x)", opcode, ptr_rqb_src);
        HIF_FATAL(0);
    }
        ...
        LSA_VOID** ppRqbDest )
{
        ...
        ||(opcode==HIF_OPC_HD_LOWER_OPEN))
    {
        ...
        HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb, rqb_size, LSA_COMP_ID_HIF, HIF_MEM_TYPE_RQB);
        ...
        else
        {
            ...
            new_rqb=(HIF_RQB_TYPE*)HIF_CAST_TO_VOID_PTR((LSA_UINT8*)new_rqb+HIF_SER_SIZEOF(4));                                     /* real lower rqb src without orig. upper RQB pointer */
    ...
    {
        HIF_PROGRAM_TRACE_02(0,LSA_TRACE_LEVEL_FATAL,"hif_hif_deserialize_lower(). RQB-Opcode:0x%x is not valid! shm_addr(0x%08x)", opcode, ptr_rqb_src);
        HIF_FATAL(0);
    }
