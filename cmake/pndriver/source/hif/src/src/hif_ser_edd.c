...
/*  HASH-VALUE: GPTO8h2LoQLKzc655JQ8lOMOirs2PIC8psUOSYcAxr0=                 */
/*****************************************************************************/
    ...
    LSA_UINT32*    pSerRqbLen )
{
    ...
    if (opcode==EDD_OPC_OPEN_CHANNEL)
    {
        ...
        rqb_size+=HIF_SER_SIZEOF(4);        /* "pParam" pointer itself */
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,ptr_rqb_src->pParam);        /* pointer info itself */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_RECV) )
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer);            /* pointer info itself */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SEND) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            {
                rqb_size+=HIF_SER_SIZEOF_BUF(((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->Length);            /* size of: pBuffer */
            }
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer);            /* pointer info itself */
            if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer /*#11*/))
            {
                HIF_SER_COPY_HTSHM_BUFFER(&help_ptr,((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer,((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->Length, hSysDev);            /* pBuffer */
            }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SET_ARP_FILTER) )
    {
        ...
        {
            rqb_size+=HIF_SER_SIZEOF(1);            /* Mode */
            rqb_size+=HIF_SER_SIZEOF(1);            /* UserIndex */
            rqb_size+=(HIF_SER_SIZEOF(1) * EDD_IP_ADDR_SIZE);            /* IPAdr */
        }
        help_ptr = hif_mem_ring_pool_alloc(rqb_size, hShmPool);
        HIF_PROGRAM_TRACE_05(0,LSA_TRACE_LEVEL_NOTE_LOW,"hif_edd_serialize_upper() RQB-Opcode:0x%x / Service:0x%x, rqb_size_shm(%d) shm_addr(0x%08x) pRQB(0x%08x)",opcode,service,rqb_size,help_ptr,ptr_rqb_src);
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_SET_ARP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->UserIndex);                        /* UserIndex */
            for(i=0;i<EDD_IP_ADDR_SIZE;i++)                                    /* IPAddr*/
            {
                HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_SET_ARP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->IPAddr.IPAdr[i]);                        /* IPAdr */
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SET_DCP_FILTER) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            for(i=0;i<((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLVCnt;i++)            /* FilterTLV*/
            {
                ...
                {
                    rqb_size+=HIF_SER_SIZEOF_BUF(((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].TLVLen);                /* size of: pTLV */
                }
            }
        }
        help_ptr = hif_mem_ring_pool_alloc(rqb_size, hShmPool);
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            for(i=0;i<((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLVCnt;i++)                                                /* FilterTLV*/
            {
                ...
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].pTLV);                /* pointer info itself */
                if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].pTLV /*#11*/))
                {
                    HIF_SER_COPY_HTSHM_BUFFER(&help_ptr,((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].pTLV,((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].TLVLen, hSysDev);                /* pTLV */
                }
            }
        }
    }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_LINK_STATUS_IND_PROVIDE_EXT) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            rqb_size+=HIF_SER_SIZEOF(1);            /* IsPOF */
            rqb_size+=HIF_SER_SIZEOF(1);            /* ShortPreamble */
            rqb_size+=HIF_SER_SIZEOF(1);            /* TxFragmentation */
            rqb_size+=HIF_SER_SIZEOF(1);            /* AddCheckEnabled */
            rqb_size+=HIF_SER_SIZEOF(1);            /* ChangeReason */
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->IsPOF);                        /* IsPOF */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->ShortPreamble);                        /* ShortPreamble */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->TxFragmentation);                        /* TxFragmentation */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->AddCheckEnabled);                        /* AddCheckEnabled */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->ChangeReason);                        /* ChangeReason */
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(ptr_rqb_src->pParam))->SyncId0_TopoOk);                        /* SyncId0_TopoOk */
        }
    }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_STATISTICS_ALL) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            {
                rqb_size+=HIF_SER_SIZEOF(4);                /* RequestedCounters */
            }
        }
        help_ptr = hif_mem_ring_pool_alloc(rqb_size, hShmPool);
        HIF_PROGRAM_TRACE_05(0,LSA_TRACE_LEVEL_NOTE_LOW,"hif_edd_serialize_upper() RQB-Opcode:0x%x / Service:0x%x, rqb_size_shm(%d) shm_addr(0x%08x) pRQB(0x%08x)",opcode,service,rqb_size,help_ptr,ptr_rqb_src);
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->Reset);                        /* Reset */
            for(i=0;i<EDD_CFG_MAX_PORT_CNT+1;i++)                                                /* sMIB*/
            {
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].RequestedCounters);                                /* RequestedCounters */
            }
        }
    }
    else
    ...
    LSA_UINT32*    pSerRqbLen )
{
    ...
    if (opcode==EDD_OPC_OPEN_CHANNEL)
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#14*/
        {
            ...
            HIF_FREE_LOCAL_MEMORY(&freeRes, ptr_rqb_src->pParam, LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB);
        ...
        freeRes = LSA_RET_ERR_RESOURCE; /* preset negative */
        HIF_FREE_LOCAL_MEMORY(&freeRes, (LSA_UINT8*)ptr_rqb_src-HIF_SER_SIZEOF(4), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB);
        if (freeRes != LSA_RET_OK)
        {
            return HIF_ERR_RESOURCE;
        }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_RECV) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            rqb_size+=HIF_SER_SIZEOF(4);            /* serialize "pBuffer" pointer itself */
            if ((HIF_IS_NOT_NULL(((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer)) && (((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->IOCount <= EDD_FRAME_BUFFER_LENGTH /* #8*/))
            {
                rqb_size+=HIF_SER_SIZEOF_BUF(((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->IOCount);            /* size of: pBuffer */
            }
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer);            /* pointer info itself */
            if ((HIF_IS_NOT_NULL(((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer)) && (((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->IOCount <= EDD_FRAME_BUFFER_LENGTH /*#11*/))
            {
                HIF_SER_COPY_HTSHM_BUFFER(&help_ptr,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->IOCount, hSysDev);            /* pBuffer */
            }
            ...
            {
                HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->doSwFwd[i]);                        /* doSwFwd */
            }
        }

        /* Delete lower RQB after lower serialization */
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#2*/
        {
            if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer)) /*#13*/
            {
                freeRes = LSA_RET_ERR_RESOURCE; /* preset negative */
                HIF_FREE_NRT_MEMORY(&freeRes,((EDD_UPPER_NRT_RECV_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer, ((HIF_PIPE_PTR_TYPE)pHifPipeHandle)->hd_id, LSA_COMP_ID_EDD, HIF_MEM_TYPE_NRT_RX_BUFFER, hSysDev);
                if (freeRes != LSA_RET_OK)
                {
                    return HIF_ERR_RESOURCE;
                }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SEND) )
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->TxTimePresent);                        /* TxTimePresent */
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#2*/
        {
            ...
            {
                freeRes = LSA_RET_ERR_RESOURCE; /* preset negative */
                HIF_FREE_NRT_MEMORY(&freeRes,((EDD_UPPER_NRT_SEND_PTR_TYPE)(ptr_rqb_src->pParam))->pBuffer, ((HIF_PIPE_PTR_TYPE)pHifPipeHandle)->hd_id, LSA_COMP_ID_EDD, HIF_MEM_TYPE_NRT_TX_BUFFER, hSysDev);
                if (freeRes != LSA_RET_OK)
                {
                    return HIF_ERR_RESOURCE;
                }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SET_DCP_FILTER) )
    {
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#2*/
        {
            for(i=0;i<((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLVCnt;i++)        /* free pointer in array FilterTLV*/
            {
                if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].pTLV)) /*#13*/
                {
                    freeRes = LSA_RET_ERR_RESOURCE; /* preset negative */
                    HIF_FREE_LOCAL_MEMORY(&freeRes, ((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(ptr_rqb_src->pParam))->FilterTLV[i].pTLV, LSA_COMP_ID_EDD, HIF_MEM_TYPE_BUFFER, hSysDev);
                    if (freeRes != LSA_RET_OK)
                    {
                        return HIF_ERR_RESOURCE;
                    }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PARAMS) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            rqb_size+=HIF_SER_SIZEOF(4);            /* FeatureMask */
            ...
            rqb_size+=HIF_SER_SIZEOF(1);            /* MaxMRPInterconn_Instances */
            ...
            rqb_size+=HIF_SER_SIZEOF(1);            /* SupportedMRPInterconnRole */
            rqb_size+=HIF_SER_SIZEOF(1);            /* MRAEnableLegacyMode */
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->FeatureMask);                        /* FeatureMask */
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->MaxMRPInterconn_Instances);                        /* MaxMRPInterconn_Instances */
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->SupportedMRPInterconnRole);                        /* SupportedMRPInterconnRole */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->MRAEnableLegacyMode);                        /* MRAEnableLegacyMode */
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->ConsumerCntClass12Combined);                        /* ConsumerCntClass12Combined */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PORT_PARAMS) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            rqb_size+=HIF_SER_SIZEOF(1);            /* SupportsMRPInterconnPortConfig */
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->IsPOF);                        /* IsPOF */
            for(i=0;i<EDD_MAC_ADDR_SIZE;i++)                                    /* MACAddr*/
            {
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->SupportsMRPInterconnPortConfig);                        /* SupportsMRPInterconnPortConfig */
            ...
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->IsWireless);                        /* IsWireless */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->IsMDIX);                        /* IsMDIX */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->ShortPreamble);                        /* ShortPreamble */
            HIF_SER_COPY_HTSHM_8((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(ptr_rqb_src->pParam))->TxFragmentation);                        /* TxFragmentation */
        }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_STATISTICS_ALL) )
    {
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam)) /*#6*/
        {
            ...
            for(i=0;i<EDD_CFG_MAX_PORT_CNT+1;i++)            /* sMIB*/
            {
                rqb_size+=HIF_SER_SIZEOF(4);                /* SupportedCounters */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InOctets */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InNUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InDiscards */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InErrors */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InUnknownProtos */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutOctets */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutNUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutDiscards */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutErrors */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutQLen */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InMulticastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* InBroadcastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutMulticastPkts */
                rqb_size+=HIF_SER_SIZEOF(4);                /* OutBroadcastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* InHCOctets */
                rqb_size+=HIF_SER_SIZEOF(8);                /* InHCUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* InHCMulticastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* InHCBroadcastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* OutHCOctets */
                rqb_size+=HIF_SER_SIZEOF(8);                /* OutHCUcastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* OutHCMulticastPkts */
                rqb_size+=HIF_SER_SIZEOF(8);                /* OutHCBroadcastPkts */
            }
        }
        help_ptr = hif_mem_ring_pool_alloc(rqb_size, hShmPool);
        HIF_PROGRAM_TRACE_05(0,LSA_TRACE_LEVEL_NOTE_LOW,"hif_edd_serialize_lower() RQB-Opcode:0x%x / Service:0x%x, rqb_size_shm(%d) shm_addr(0x%08x) pRQB(0x%08x)",opcode,service,rqb_size,help_ptr,ptr_rqb_src);
        ...
        *ptr_ptr_rqb_dest = help_ptr;
        ...
        if (HIF_IS_NOT_NULL(ptr_rqb_src->pParam))  /*#9*/
        {
            ...
            for(i=0;i<EDD_CFG_MAX_PORT_CNT+1;i++)                                                /* sMIB*/
            {
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].SupportedCounters);                                /* SupportedCounters */
                ...
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InDiscards);                                /* InDiscards */
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InErrors);                                /* InErrors */
                ...
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutUcastPkts);                                /* OutUcastPkts */
                ...
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutDiscards);                                /* OutDiscards */
                ...
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InMulticastPkts);                                /* InMulticastPkts */
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InBroadcastPkts);                                /* InBroadcastPkts */
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutMulticastPkts);                                /* OutMulticastPkts */
                HIF_SER_COPY_HTSHM_32((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutBroadcastPkts);                                /* OutBroadcastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InHCOctets);                                /* InHCOctets */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InHCUcastPkts);                                /* InHCUcastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InHCMulticastPkts);                                /* InHCMulticastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].InHCBroadcastPkts);                                /* InHCBroadcastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutHCOctets);                                /* OutHCOctets */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutHCUcastPkts);                                /* OutHCUcastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutHCMulticastPkts);                                /* OutHCMulticastPkts */
                HIF_SER_COPY_HTSHM_64((LSA_UINT32**)&help_ptr,((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(ptr_rqb_src->pParam))->sMIB[i].OutHCBroadcastPkts);                                /* OutHCBroadcastPkts */
            }
        }
        ...
        LSA_VOID** ppRqbDest )
{
    ...
    if (opcode==EDD_OPC_OPEN_CHANNEL)
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
        ...
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
            help_ptr+=HIF_SER_SIZEOF(4);
        }
    }
    else if (opcode==EDD_OPC_CLOSE_CHANNEL)
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_RECV) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr) && ((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->IOCount <= EDD_FRAME_BUFFER_LENGTH) /*#22b*/
            {
                help_ptr+=HIF_SER_SIZEOF(4); /* skip buffer-pointer */
                if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->pBuffer)) /*#24*/
                {
                    HIF_SER_COPY_SHMTH_BUF(((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->pBuffer,&help_ptr,((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->IOCount);            /* pBuffer */
                }
            }
            else
            {
            ...
            {
                HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->doSwFwd[i],(LSA_UINT32**)&help_ptr);            /* doSwFwd */
            }
        }
        else
        {
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SEND) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            help_ptr+=HIF_SER_SIZEOF(4);
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->TxTimePresent,(LSA_UINT32**)&help_ptr);            /* TxTimePresent */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->TxTime,(LSA_UINT32**)&help_ptr);            /* TxTime */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->LineDelayInTicksHardware,(LSA_UINT32**)&help_ptr);            /* LineDelayInTicksHardware */
        }
        else
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_LINK_STATUS_IND_PROVIDE) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->PortState,(LSA_UINT32**)&help_ptr);            /* PortState */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->MAUType,(LSA_UINT32**)&help_ptr);            /* MAUType */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->MediaType,(LSA_UINT32**)&help_ptr);            /* MediaType */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->IsPOF,(LSA_UINT32**)&help_ptr);            /* IsPOF */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->ShortPreamble,(LSA_UINT32**)&help_ptr);            /* ShortPreamble */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->TxFragmentation,(LSA_UINT32**)&help_ptr);            /* TxFragmentation */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->AddCheckEnabled,(LSA_UINT32**)&help_ptr);            /* AddCheckEnabled */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->ChangeReason,(LSA_UINT32**)&help_ptr);            /* ChangeReason */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->LineDelayInTicksMeasured,(LSA_UINT32**)&help_ptr);            /* LineDelayInTicksMeasured */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->CableDelayInNsMeasured,(LSA_UINT32**)&help_ptr);            /* CableDelayInNsMeasured */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->PortTxDelay,(LSA_UINT32**)&help_ptr);            /* PortTxDelay */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->PortRxDelay,(LSA_UINT32**)&help_ptr);            /* PortRxDelay */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->SyncId0_TopoOk,(LSA_UINT32**)&help_ptr);            /* SyncId0_TopoOk */
        }
        else
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PARAMS) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            help_ptr+=HIF_SER_SIZEOF(4);
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->InterfaceID,(LSA_UINT32**)&help_ptr);            /* InterfaceID */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->HardwareType,(LSA_UINT32**)&help_ptr);            /* HardwareType */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->FeatureMask,(LSA_UINT32**)&help_ptr);            /* FeatureMask */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->TraceIdx,(LSA_UINT32**)&help_ptr);            /* TraceIdx */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->TimeResolutionInNs,(LSA_UINT32**)&help_ptr);            /* TimeResolutionInNs */
            for(i=0;i<EDD_MAC_ADDR_SIZE;i++)                                    /* MacAdr*/
            {
                HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MACAddr.MacAdr[i],(LSA_UINT32**)&help_ptr);            /* MacAdr */
            }
            for(i=0;i<EDD_IP_ADDR_SIZE;i++)                                    /* IPAdr*/
            {
                HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->LocalIP.IPAdr[i],(LSA_UINT32**)&help_ptr);            /* IPAdr */
            }
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MaxPortCnt,(LSA_UINT32**)&help_ptr);            /* MaxPortCnt */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MaxPortCntOfAllEDD,(LSA_UINT32**)&help_ptr);            /* MaxPortCntOfAllEDD */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MaxInterfaceCntOfAllEDD,(LSA_UINT32**)&help_ptr);            /* MaxInterfaceCntOfAllEDD */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MaxMRP_Instances,(LSA_UINT32**)&help_ptr);            /* MaxMRP_Instances */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MaxMRPInterconn_Instances,(LSA_UINT32**)&help_ptr);            /* MaxMRPInterconn_Instances */
            ...
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->SupportedMRPInterconnRole,(LSA_UINT32**)&help_ptr);            /* SupportedMRPInterconnRole */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->MRAEnableLegacyMode,(LSA_UINT32**)&help_ptr);            /* MRAEnableLegacyMode */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->CycleBaseFactor,(LSA_UINT32**)&help_ptr);            /* CycleBaseFactor */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerFrameIDBaseClass3,(LSA_UINT32**)&help_ptr);            /* ConsumerFrameIDBaseClass3 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerCntClass3,(LSA_UINT32**)&help_ptr);            /* ConsumerCntClass3 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerFrameIDBaseClass2,(LSA_UINT32**)&help_ptr);            /* ConsumerFrameIDBaseClass2 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerCntClass2,(LSA_UINT32**)&help_ptr);            /* ConsumerCntClass2 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerFrameIDBaseClass1,(LSA_UINT32**)&help_ptr);            /* ConsumerFrameIDBaseClass1 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerCntClass1,(LSA_UINT32**)&help_ptr);            /* ConsumerCntClass1 */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ConsumerCntClass12Combined,(LSA_UINT32**)&help_ptr);            /* ConsumerCntClass12Combined */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ProviderCnt,(LSA_UINT32**)&help_ptr);            /* ProviderCnt */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ProviderCntClass3,(LSA_UINT32**)&help_ptr);            /* ProviderCntClass3 */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->ProviderGroupCnt,(LSA_UINT32**)&help_ptr);            /* ProviderGroupCnt */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->DataLenMin,(LSA_UINT32**)&help_ptr);            /* DataLenMin */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->DataLenMax,(LSA_UINT32**)&help_ptr);            /* DataLenMax */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->DataLenMinUDP,(LSA_UINT32**)&help_ptr);            /* DataLenMinUDP */
            HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->DataLenMaxUDP,(LSA_UINT32**)&help_ptr);            /* DataLenMaxUDP */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.KRAMBaseAddr,(LSA_UINT32**)&help_ptr);            /* KRAMBaseAddr */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.offset_ProcessImageStart,(LSA_UINT32**)&help_ptr);            /* offset_ProcessImageStart */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.offset_async_in_start,(LSA_UINT32**)&help_ptr);            /* offset_async_in_start */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.size_async_in,(LSA_UINT32**)&help_ptr);            /* size_async_in */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.offset_async_out_start,(LSA_UINT32**)&help_ptr);            /* offset_async_out_start */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.size_async_out,(LSA_UINT32**)&help_ptr);            /* size_async_out */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->KRAMInfo.offset_ProcessImageEnd,(LSA_UINT32**)&help_ptr);            /* offset_ProcessImageEnd */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.RxEndNs,(LSA_UINT32**)&help_ptr);            /* RxEndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.RxLocalTransferEndNs,(LSA_UINT32**)&help_ptr);            /* RxLocalTransferEndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.TxEndNs,(LSA_UINT32**)&help_ptr);            /* TxEndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.TxLocalTransferStartNs,(LSA_UINT32**)&help_ptr);            /* TxLocalTransferStartNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.TxLocalTransferEndNs,(LSA_UINT32**)&help_ptr);            /* TxLocalTransferEndNs */
        }
        else
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PORT_PARAMS) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->IsPOF,(LSA_UINT32**)&help_ptr);            /* IsPOF */
            for(i=0;i<EDD_MAC_ADDR_SIZE;i++)                                    /* MacAdr*/
            {
                HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->MACAddr.MacAdr[i],(LSA_UINT32**)&help_ptr);            /* MacAdr */
            }
            ...
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->LineDelayInTicksMeasured,(LSA_UINT32**)&help_ptr);            /* LineDelayInTicksMeasured */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->CableDelayInNsMeasured,(LSA_UINT32**)&help_ptr);            /* CableDelayInNsMeasured */
            ...
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->SupportsMRPInterconnPortConfig,(LSA_UINT32**)&help_ptr);            /* SupportsMRPInterconnPortConfig */
            ...
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->AutonegCapAdvertised,(LSA_UINT32**)&help_ptr);            /* AutonegCapAdvertised */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Rx.BeginNs,(LSA_UINT32**)&help_ptr);            /* BeginNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Rx.EndNs,(LSA_UINT32**)&help_ptr);            /* EndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Rx.EndLocalNs,(LSA_UINT32**)&help_ptr);            /* EndLocalNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Rx.LastLocalFrameLen,(LSA_UINT32**)&help_ptr);            /* LastLocalFrameLen */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Tx.BeginNs,(LSA_UINT32**)&help_ptr);            /* BeginNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Tx.EndNs,(LSA_UINT32**)&help_ptr);            /* EndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Tx.EndLocalNs,(LSA_UINT32**)&help_ptr);            /* EndLocalNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalRed.Tx.LastLocalFrameLen,(LSA_UINT32**)&help_ptr);            /* LastLocalFrameLen */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalOrange.Rx.BeginNs,(LSA_UINT32**)&help_ptr);            /* BeginNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalOrange.Rx.EndNs,(LSA_UINT32**)&help_ptr);            /* EndNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalOrange.Tx.BeginNs,(LSA_UINT32**)&help_ptr);            /* BeginNs */
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->RsvIntervalOrange.Tx.EndNs,(LSA_UINT32**)&help_ptr);            /* EndNs */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->IsWireless,(LSA_UINT32**)&help_ptr);            /* IsWireless */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->IsMDIX,(LSA_UINT32**)&help_ptr);            /* IsMDIX */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->ShortPreamble,(LSA_UINT32**)&help_ptr);            /* ShortPreamble */
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->TxFragmentation,(LSA_UINT32**)&help_ptr);            /* TxFragmentation */
        }
        else
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_MULTICAST) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            help_ptr+=HIF_SER_SIZEOF(4);
            HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_MULTICAST_PTR_TYPE)(new_rqb->pParam))->RefCnt,(LSA_UINT32**)&help_ptr);            /* RefCnt */
        }
        else
        {
            new_rqb->pParam = LSA_NULL; /* Attention */
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_STATISTICS_ALL) )
    {
        ...
        if (HIF_IS_NOT_NULL(new_rqb->pParam) && HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#19*/
        {
            ...
            help_ptr+=HIF_SER_SIZEOF(4);
            HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->Reset,(LSA_UINT32**)&help_ptr);            /* Reset */
            for(i=0;i<EDD_CFG_MAX_PORT_CNT+1;i++)                                    /* sMIB*/
            {
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].SupportedCounters,(LSA_UINT32**)&help_ptr);                /* SupportedCounters */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InOctets,(LSA_UINT32**)&help_ptr);                /* InOctets */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InUcastPkts,(LSA_UINT32**)&help_ptr);                /* InUcastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InNUcastPkts,(LSA_UINT32**)&help_ptr);                /* InNUcastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InDiscards,(LSA_UINT32**)&help_ptr);                /* InDiscards */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InErrors,(LSA_UINT32**)&help_ptr);                /* InErrors */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InUnknownProtos,(LSA_UINT32**)&help_ptr);                /* InUnknownProtos */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutOctets,(LSA_UINT32**)&help_ptr);                /* OutOctets */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutUcastPkts,(LSA_UINT32**)&help_ptr);                /* OutUcastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutNUcastPkts,(LSA_UINT32**)&help_ptr);                /* OutNUcastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutDiscards,(LSA_UINT32**)&help_ptr);                /* OutDiscards */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutErrors,(LSA_UINT32**)&help_ptr);                /* OutErrors */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutQLen,(LSA_UINT32**)&help_ptr);                /* OutQLen */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InMulticastPkts,(LSA_UINT32**)&help_ptr);                /* InMulticastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InBroadcastPkts,(LSA_UINT32**)&help_ptr);                /* InBroadcastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutMulticastPkts,(LSA_UINT32**)&help_ptr);                /* OutMulticastPkts */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutBroadcastPkts,(LSA_UINT32**)&help_ptr);                /* OutBroadcastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InHCOctets,(LSA_UINT32**)&help_ptr);                /* InHCOctets */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InHCUcastPkts,(LSA_UINT32**)&help_ptr);                /* InHCUcastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InHCMulticastPkts,(LSA_UINT32**)&help_ptr);                /* InHCMulticastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].InHCBroadcastPkts,(LSA_UINT32**)&help_ptr);                /* InHCBroadcastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutHCOctets,(LSA_UINT32**)&help_ptr);                /* OutHCOctets */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutHCUcastPkts,(LSA_UINT32**)&help_ptr);                /* OutHCUcastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutHCMulticastPkts,(LSA_UINT32**)&help_ptr);                /* OutHCMulticastPkts */
                HIF_SER_COPY_SHMTH_64(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].OutHCBroadcastPkts,(LSA_UINT32**)&help_ptr);                /* OutHCBroadcastPkts */
            }
        }
        else
        {
    ...
    {
        HIF_PROGRAM_TRACE_03(0,LSA_TRACE_LEVEL_FATAL,"hif_edd_deserialize_upper(). RQB-Opcode:0x%x / Service:0x%x is not valid! shm_addr(0x%08x)", opcode, service, ptr_rqb_src);
        HIF_FATAL(0);
    }
        ...
        LSA_VOID** ppRqbDest )
{
    ...
    if (opcode==EDD_OPC_OPEN_CHANNEL)
    {
        ...
        HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb, rqb_size, LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB);
        ...
        else
        {
            ...
            new_rqb=(EDD_RQB_TYPE*)HIF_CAST_TO_VOID_PTR((LSA_UINT8*)new_rqb+HIF_SER_SIZEOF(4));                                     /* real lower rqb src without orig. upper RQB pointer */
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_OPEN_CHANNEL_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                HIF_SER_SYS_PATH_SHMTH(&((EDD_UPPER_OPEN_CHANNEL_PTR_TYPE)(new_rqb->pParam))->SysPath,(LSA_UINT32**)&help_ptr);                /* SysPath */
            }
        }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_RECV) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr)) /*#22a*/
                {
                    help_ptr+=HIF_SER_SIZEOF(4); /* skip buffer pointer */
                    ...
                    HIF_PROGRAM_TRACE_05(0,LSA_TRACE_LEVEL_NOTE_LOW,"hif_edd_deserialize_lower() allocate buffer buffer_size(%d) RQB-Opcode:0x%x / Service:0x%x, shm_addr(0x%08x) pRQB(0x%08x)",((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->IOCount,opcode,service,help_ptr,new_rqb+4);
                    if (HIF_IS_NULL(((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->pBuffer)) /*#23a*/
                    {
                ...
                {
                    ((EDD_UPPER_NRT_RECV_PTR_TYPE)(new_rqb->pParam))->pBuffer = LSA_NULL; /* set data buffer pointer to NULL */
                    help_ptr+=HIF_SER_SIZEOF(4);          /* skip buffer-pointer */
                }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SEND) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->Length,(LSA_UINT32**)&help_ptr);                /* Length */
                if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr) && ((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->Length > 0 ) /*#22d*/
                {
                    help_ptr+=HIF_SER_SIZEOF(4); /* skip buffer pointer */
                    ...
                    {
                        HIF_SER_COPY_SHMTH_BUF(((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->pBuffer,&help_ptr,((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->Length);                /* pBuffer */
                    }
                    else
                    {
                        return HIF_ERR_RESOURCE;
                ...
                {
                    ((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->pBuffer = LSA_NULL; /* set data buffer pointer to NULL */
                    help_ptr+=HIF_SER_SIZEOF(4);          /* skip buffer-pointer */
                }
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->Priority,(LSA_UINT32**)&help_ptr);                /* Priority */
                HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->PortID,(LSA_UINT32**)&help_ptr);                /* PortID */
                HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->FrameID,(LSA_UINT32**)&help_ptr);                /* FrameID */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SEND_PTR_TYPE)(new_rqb->pParam))->TxFrmGroup,(LSA_UINT32**)&help_ptr);                /* TxFrmGroup */
            }
            else
            {
                new_rqb->pParam = LSA_NULL;
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_CANCEL) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_NRT_CANCEL_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                ...
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_CANCEL_PTR_TYPE)(new_rqb->pParam))->RequestID,(LSA_UINT32**)&help_ptr);                /* RequestID */
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_LINK_STATUS_IND_PROVIDE) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_LINK_STATUS_IND_PROVIDE_PTR_TYPE)(new_rqb->pParam))->PortID,(LSA_UINT32**)&help_ptr);                /* PortID */
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_SET_IP) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_SET_IP_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                for(i=0;i<EDD_IP_ADDR_SIZE;i++)                                                /* IPAdr*/
                {
                    HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_SET_IP_PTR_TYPE)(new_rqb->pParam))->LocalIP.IPAdr[i],(LSA_UINT32**)&help_ptr);                /* IPAdr */
                }
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SET_ARP_FILTER) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_NRT_SET_ARP_FILTER_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                ...
                HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_NRT_SET_ARP_FILTER_PTR_TYPE)(new_rqb->pParam))->UserIndex,(LSA_UINT32**)&help_ptr);                /* UserIndex */
                for(i=0;i<EDD_IP_ADDR_SIZE;i++)                                                /* IPAdr*/
                {
                    HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_NRT_SET_ARP_FILTER_PTR_TYPE)(new_rqb->pParam))->IPAddr.IPAdr[i],(LSA_UINT32**)&help_ptr);                /* IPAdr */
                }
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_NRT_SET_DCP_FILTER) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                ...
                for(i=0;i<((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLVCnt;i++)                                                /* FilterTLV*/
                {
                    HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].TLVLen,(LSA_UINT32**)&help_ptr);                    /* TLVLen */
                    if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr) && ((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].TLVLen > 0 ) /*#22d*/
                    {
                        help_ptr+=HIF_SER_SIZEOF(4); /* skip buffer pointer */
                        HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].pTLV,((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].TLVLen, LSA_COMP_ID_EDD, HIF_MEM_TYPE_BUFFER );
                        HIF_PROGRAM_TRACE_05(0,LSA_TRACE_LEVEL_NOTE_LOW,"hif_edd_deserialize_lower() allocate buffer buffer_size(%d) RQB-Opcode:0x%x / Service:0x%x, shm_addr(0x%08x) pRQB(0x%08x)",((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].TLVLen,opcode,service,help_ptr,new_rqb+4);
                        if (HIF_IS_NOT_NULL(((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].pTLV)) /*#23*/
                        {
                            HIF_SER_COPY_SHMTH_BUF(((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].pTLV,&help_ptr,((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].TLVLen);                    /* pTLV */
                        }
                        else
                        {
                            return HIF_ERR_RESOURCE;
                    ...
                    {
                        ((EDD_UPPER_NRT_SET_DCP_FILTER_PTR_TYPE)(new_rqb->pParam))->FilterTLV[i].pTLV = LSA_NULL; /* set data buffer pointer to NULL */
                        help_ptr+=HIF_SER_SIZEOF(4);          /* skip buffer-pointer */
                    }
                }
            }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PARAMS) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_GET_PARAMS_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_PORT_PARAMS) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_GET_PORT_PARAMS_PTR_TYPE)(new_rqb->pParam))->PortID,(LSA_UINT32**)&help_ptr);                /* PortID */
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_MULTICAST) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_MULTICAST_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                ...
                for(i=0;i<EDD_MAC_ADDR_SIZE;i++)                                                /* MacAdr*/
                {
                    HIF_SER_COPY_SHMTH_8(&((EDD_UPPER_MULTICAST_PTR_TYPE)(new_rqb->pParam))->MACAddr.MacAdr[i],(LSA_UINT32**)&help_ptr);                /* MacAdr */
                }
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_LED_BLINK) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_LED_BLINK_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
    ...
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_SET_REMOTE_PORT_STATE) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                HIF_SER_COPY_SHMTH_16(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->PortID,(LSA_UINT32**)&help_ptr);                /* PortID */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->SyncId0_TopoState,(LSA_UINT32**)&help_ptr);                /* SyncId0_TopoState */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->RtClass2_TopoState,(LSA_UINT32**)&help_ptr);                /* RtClass2_TopoState */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->RtClass3_TopoState,(LSA_UINT32**)&help_ptr);                /* RtClass3_TopoState */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->RtClass3_PDEVTopoState,(LSA_UINT32**)&help_ptr);                /* RtClass3_PDEVTopoState */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->RtClass3_RemoteState,(LSA_UINT32**)&help_ptr);                /* RtClass3_RemoteState */
                HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_SET_REMOTE_PORT_STATE_PTR_TYPE)(new_rqb->pParam))->Neighbour_TopoState,(LSA_UINT32**)&help_ptr);                /* Neighbour_TopoState */
            }
        }
    }
    else if ( (opcode==EDD_OPC_REQUEST) && (service == EDD_SRV_GET_STATISTICS_ALL) )
    {
        ...
        else
        {
            ...
            *ptr_ptr_rqb_dest = new_rqb;                                    /* return real lower rqb src without orig. upper RQB pointer */
            ...
            if (HIF_IS_NOT_NULL_U32_REF_BY_PTR(help_ptr))            /* check pointer "pParam" on shared-mem */ /*#18*/
            {
                HIF_ALLOC_LOCAL_MEM((LSA_VOID**)&new_rqb->pParam, /*lint --e(866) */ sizeof(*(EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam)), LSA_COMP_ID_EDD, HIF_MEM_TYPE_RQB );
                if (HIF_IS_NULL(((EDD_RQB_TYPE*)new_rqb)->pParam))
                {
                    return HIF_ERR_RESOURCE;
                }
            ...
            if (HIF_IS_NOT_NULL(new_rqb->pParam)) /*#if1*/
            {
                ...
                for(i=0;i<EDD_CFG_MAX_PORT_CNT+1;i++)                                                /* sMIB*/
                {
                    HIF_SER_COPY_SHMTH_32(&((EDD_UPPER_GET_STATISTICS_ALL_PTR_TYPE)(new_rqb->pParam))->sMIB[i].RequestedCounters,(LSA_UINT32**)&help_ptr);                    /* RequestedCounters */
                }
            }
        }
    }
    ...
    {
        HIF_PROGRAM_TRACE_03(0,LSA_TRACE_LEVEL_FATAL,"hif_edd_deserialize_lower(). RQB-Opcode:0x%x / Service:0x%x is not valid! shm_addr(0x%08x)", opcode, service, ptr_rqb_src);
        HIF_FATAL(0);
    }
    *ptr_ptr_rqb_dest = new_rqb;
