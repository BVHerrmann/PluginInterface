...
#define POOL_NUM      ((17 * 5) + 5/*user pools*/ + 1/*eps or mem3 counts different*/)     /* the maximum number of pools. See eps_cp_mem: ((EPS_MAX_BOARD_NR + 1) * POOL_NR_MAX) + EPS_MEM_MAX_USER_POOLS*/
