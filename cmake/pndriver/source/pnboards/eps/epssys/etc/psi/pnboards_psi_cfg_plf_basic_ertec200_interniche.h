#ifndef PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC200_INTERNICHE_H    /* ----- reinclude-protection ----- */
#define PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC200_INTERNICHE_H
...
/*                                                                           */
/*  F i l e               &F: pnboards_psi_cfg_plf_basic_ertec200_interniche.h:F& */
/*                                                                           */
...
/*                                                                           */
/*  PSI EPS settings for EB200 board and TCIP-Stack is interniche.           */
/*                                                                           */
/*****************************************************************************/
...
// check the including of this header only for EB200 board
#if (EPS_PLF != EPS_PLF_ERTEC200_ARM9)
#error "(EPS_PLF != EPS_PLF_ERTEC200_ARM9) in <pnboards_psi_cfg_plf_basic_ertec200_interniche.h>"
#endif

#define EPS_PLATFORM_NAME "ERTEC200"
...
#define PSI_CFG_EDDI_CFG_ERTEC_200
...
#if PSI_CFG_USE_IOC
    #define PSI_CFG_MAX_CL_DEVICES      8   // Max devices for create client
    #define PSI_CFG_MAX_CL_OSU_DEVICES  8   // range 1..32 (see EDD_DCP_MAX_DCP_HELLO_FILTER(=32))
#endif

#if PSI_CFG_USE_IOM
    #define PSI_CFG_MAX_MC_DEVICES      8   // Max devices for create MC client
#endif

#if PSI_CFG_USE_IOD
    #define PSI_CFG_MAX_SV_DEVICES      1   // Maximum numbers of IOD instances, e.g. 64 for IEPB link, 1 for other UseCases
    #define PSI_CFG_MAX_SV_IO_ARS       2   // Maximum number of ARs for cyclic communication (RTC123 IO CRs)
#endif
...
#endif  /* of PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC200_INTERNICHE_H */
