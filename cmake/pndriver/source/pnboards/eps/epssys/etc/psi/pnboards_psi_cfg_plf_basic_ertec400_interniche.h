#ifndef PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC400_INTERNICHE_H    /* ----- reinclude-protection ----- */
#define PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC400_INTERNICHE_H
...
/*                                                                           */
/*  F i l e               &F: pnboards_psi_cfg_plf_basic_ertec400_interniche.h:F& */
/*                                                                           */
...
/*                                                                           */
/*  PSI EPS settings for EB400 (CP1616) board and TCIP-Stack is interniche.  */
/*                                                                           */
/*****************************************************************************/
...
// check the including of this header only for EB400 board
#if (EPS_PLF != EPS_PLF_ERTEC400_ARM9)
#error "(EPS_PLF != EPS_PLF_ERTEC400_ARM9) in <pnboards_psi_cfg_plf_basic_ertec400_interniche.h>"
#endif

#define EPS_PLATFORM_NAME "ERTEC400"
...
#if PSI_CFG_USE_IOD
    #define PSI_CFG_MAX_SV_DEVICES      1         
...
#endif  /* of PNBOARDS_PSI_CFG_PLF_BASIC_ERTEC400_INTERNICHE_H */
