#ifndef PCIOX_PSI_CFG_PLF_WPCAP_OBSD_H  /* ----- reinclude-protection ----- */
#define PCIOX_PSI_CFG_PLF_WPCAP_OBSD_H
...
/*                                                                           */
/*  F i l e               &F: pciox_psi_cfg_plf_wpcap_obsd.h            :F&  */
/*                                                                           */
...
/*                                                                           */
/*  PSI EPS Platform defintions for EDDS WPCAP only.                         */
/*                                                                           */
/*****************************************************************************/

/* included by "pnboards_psi_cfg_plf_eps.h" */
#define PCIOX_PLATFORM_NAME "WPCAP_OBSD"
...
// Select the EDDT configuration
    ...
    #define IOH_CFG_USE_IRTE            0
    #define IOH_CFG_USE_PERIF           0
    #define IOH_CFG_USE_EDDS_IOBUFFER   1
    #define IOH_CFG_USE_HERA            0
#endif
...
#endif  /* of PCIOX_PSI_CFG_PLF_WPCAP_OBSD_H */
