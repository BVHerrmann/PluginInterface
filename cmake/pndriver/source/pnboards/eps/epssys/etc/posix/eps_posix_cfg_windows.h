#ifndef _EPS_POSIX_CFG_WINDOWS_H_
#define _EPS_POSIX_CFG_WINDOWS_H_
...
/*                                                                           */
/*  F i l e               &F: eps_posix_cfg_windows.h                   :F&  */
/*                                                                           */
...
#define EPS_POSIX_PTHREAD_ATTR_INIT                 pthread_attr_init
#define EPS_POSIX_PTHREAD_GETSCHEDPOLICY            pthread_attr_getschedpolicy
...
#define EPS_POSIX_THREAD_PRIORITY_BELOW_NORMAL    	3
#define EPS_POSIX_THREAD_PRIORITY_NORMAL    		5
#define EPS_POSIX_THREAD_PRIORITY_ABOVE_NORMAL   	7		
/* Same Windows Prio is used for EPS_POSIX_THREAD_PRIORITY_HIGH and EPS_POSIX_THREAD_PRIORITY_TIMER
   For different Prios here addtional Windows Prio and new Cases in 
   p2w_map_posix_prio_to_win/p2w_map_win_prio_to_posix have to be added in posix2win.c as well! */
#define EPS_POSIX_THREAD_PRIORITY_HIGH              30
#define EPS_POSIX_THREAD_PRIORITY_TIMER             30
#define EPS_POSIX_THREAD_PRIORITY_HIGH_PERFORMANCE 	31

#ifdef __cplusplus  /* If C++ - compiler: End of C linkage */
}
#endif

#endif  /* of _EPS_POSIX_CFG_WINDOWS_H_ */
