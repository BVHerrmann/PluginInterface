...
static LSA_VOID   eps_hif_short_drv_uninstall       (LSA_VOID);
static LSA_UINT16 eps_hif_short_drv_open            (struct eps_hif_drv_openpar_tag const* pInPars, EPS_HIF_DRV_HW_PTR_TYPE* ppHwInstOut, LSA_UINT16 hd_id, LSA_BOOL bUpper);
static LSA_UINT16 eps_hif_short_drv_close           (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn);
static LSA_UINT16 eps_hif_short_drv_enable_isr      (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn, LSA_UINT16 hHif);
static LSA_UINT16 eps_hif_short_drv_disable_isr     (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn);
static LSA_UINT16 eps_hif_short_drv_send_hif_ir     (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn);
static LSA_UINT16 eps_hif_short_drv_ack_hif_ir      (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn);
static LSA_UINT16 eps_hif_short_drv_reenable_hif_ir (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn);
static LSA_VOID   eps_hif_short_drv_dmacpy          (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn, LSA_VOID* pDst, LSA_VOID* pSrc, LSA_UINT32 uLength);
static LSA_BOOL   eps_hif_short_drv_dma_pend_free   (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn, LSA_VOID* pBuffer, LSA_VOID_PTR_TYPE *ppReadyForFree);
static LSA_VOID   eps_hif_short_drv_get_params      (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn, LSA_VOID* pPar);
...
static EPS_HIF_SHORT_DRV_TYPE g_EpsHifShortDrv;
static EPS_HIF_SHORT_DRV_PTR_TYPE g_pEpsHifShortDrv = LSA_NULL;
...
{
    LSA_UINT16 retVal;
	retVal = eps_free_critical_section(g_pEpsHifShortDrv->hEnterExit);
...
{
    LSA_UINT16 retVal;
	retVal = eps_alloc_critical_section(&g_pEpsHifShortDrv->hEnterExit, LSA_FALSE);
    EPS_ASSERT( LSA_RET_OK == retVal );
}
 ...
 */
static EPS_HIF_SHORT_DRV_INST_PTR_TYPE eps_hif_short_drv_get_inst (EPS_HIF_DRV_HW_CONST_PTR_TYPE pHwInstIn)
{
...
LSA_VOID eps_hif_short_drv_install (LSA_VOID)
{
	...
	sHifDrvIf.DmaPendFree   = eps_hif_short_drv_dma_pend_free;
 ...
 */
static LSA_UINT16 eps_hif_short_drv_open (EPS_HIF_DRV_OPENPAR_CONST_PTR_TYPE pInPars, EPS_HIF_DRV_HW_PTR_PTR_TYPE ppHwInstOut, LSA_UINT16 hd_id, LSA_BOOL bUpper)
{
...
/**
 * hif: pends a free for buffer in use by dma - short mode function  
 * 
 * exists for reason of specification - Throws EPS_FATAL
 * @return LSA_FALSE
 */
