...
// Partitioning of the DEV and NRT memory for ERTEC400, all values in percent
#define CP_MEM_ERTEC400_PERCENT_DEV                 0
#define CP_MEM_ERTEC400_PERCENT_NRT_TX              30
#define CP_MEM_ERTEC400_PERCENT_NRT_RX              66
#define CP_MEM_ERTEC400_PERCENT_NRT_DMACW_DEFAULT   4

#define CP_MEM_ERTEC400_PERCENT_TOTAL (CP_MEM_ERTEC400_PERCENT_DEV + CP_MEM_ERTEC400_PERCENT_NRT_TX + CP_MEM_ERTEC400_PERCENT_NRT_RX + CP_MEM_ERTEC400_PERCENT_NRT_DMACW_DEFAULT)

#if (CP_MEM_ERTEC400_PERCENT_TOTAL != 100)
...
static EPS_ERTEC400_HW_STORE_TYPE eps_ertec400_hw_store[PSI_CFG_MAX_IF_CNT+1];
...
LSA_VOID eps_ertec400_FillDevNrtMemParams( LSA_VOID * const pBoardInfoVoid )
{
    ...
    pboardInfo->dev_mem.size        = EPS_CALC_MEM_SIZE(dev_nrt_mem_size_all, CP_MEM_ERTEC400_PERCENT_DEV);
    ...
    pboardInfo->nrt_tx_mem.size     = EPS_CALC_MEM_SIZE(dev_nrt_mem_size_all, CP_MEM_ERTEC400_PERCENT_NRT_TX);
    ...
    pboardInfo->nrt_rx_mem.size     = EPS_CALC_MEM_SIZE(dev_nrt_mem_size_all, CP_MEM_ERTEC400_PERCENT_NRT_RX);
    ...
    pboardInfo->eddi.nrt_mem_dmacw_default.size           = EPS_CALC_MEM_SIZE(dev_nrt_mem_size_all, CP_MEM_ERTEC400_PERCENT_NRT_DMACW_DEFAULT);
...
LSA_VOID eps_i2c_set_scl_low_highz_ERTEC400( LSA_SYS_PTR_TYPE sysPtr, LSA_BOOL level )
{
	EPS_BOARD_INFO_PTR_TYPE pBoard;
	EPS_SYS_PTR_TYPE        pSys;
	EPS_ASSERT( sysPtr );
...
/*----------------------------------------------------------------------------*/
LSA_VOID eps_i2c_set_sda_low_highz_ERTEC400( LSA_SYS_PTR_TYPE sysPtr, LSA_BOOL level )
{
...
LSA_BOOL eps_i2c_select_ERTEC400( LSA_SYS_PTR_TYPE sysPtr, LSA_UINT16 PortId, LSA_UINT16 I2CMuxSelect ) // implementation for EB400 PCIe board
{
	...
	switch (hw_port_id)
	{
		...
		case 4: // = HwPortId 4
			...
			break;
        default:
            EPS_FATAL("eps_i2c_select_ERTEC400(): not expected HwPortId");
            break;
	}
