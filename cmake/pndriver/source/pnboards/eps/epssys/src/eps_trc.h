...
/*
PNTRC specfic for new Sync Mode. Should not be mapped to LSA-Macros since this solution is non existing for LTRC or BTRC
These macros are not scanned by the LTRC scanner
*/
#define EPS_SYSTEM_TRACE_SYNC_TIME_START(idx_, level_, msg_, para1_, para2_)
#define EPS_SYSTEM_TRACE_SYNC_TIME_LOCAL(idx_, level_, msg_, para1_, para2_)
#define EPS_SYSTEM_TRACE_SYNC_TIME_LOWER(idx_, level_, msg_, para1_, para2_, para3_)
#define EPS_SYSTEM_TRACE_SYNC_TIME_SCALER(idx_, level_, msg_, para1_, para2_)
...
These macros are not scanned by the LTRC scanner
*/
#ifndef EPS_SYSTEM_TRACE_SYNC_TIME_START
#define EPS_SYSTEM_TRACE_SYNC_TIME_START(idx_, level_, msg_, para1_, para2_) \
    PNTRC_TRACE_SYNC_TIME_START(TRACE_SUBSYS_PNTRC_SYSTEM, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef EPS_SYSTEM_TRACE_SYNC_TIME_LOCAL
#define EPS_SYSTEM_TRACE_SYNC_TIME_LOCAL(idx_, level_, msg_, para1_, para2_) \
    PNTRC_TRACE_SYNC_TIME_LOCAL(TRACE_SUBSYS_PNTRC_SYSTEM, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef EPS_SYSTEM_TRACE_SYNC_TIME_LOWER
#define EPS_SYSTEM_TRACE_SYNC_TIME_LOWER(idx_, level_, msg_, para1_, para2_, para3_) \
    PNTRC_TRACE_SYNC_TIME_LOWER(TRACE_SUBSYS_PNTRC_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef EPS_SYSTEM_TRACE_SYNC_TIME_SCALER
#define EPS_SYSTEM_TRACE_SYNC_TIME_SCALER(idx_, level_, msg_, para1_, para2_) \
    PNTRC_TRACE_SYNC_TIME_SCALER(TRACE_SUBSYS_PNTRC_SYSTEM, idx_, level_, msg_, para1_, para2_)
#endif
...
#ifndef EPS_SYSTEM_TRACE_00
#define EPS_SYSTEM_TRACE_00(idx_, level_, msg_) \
    LSA_IDX_TRACE_00(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_)
#endif

#ifndef EPS_SYSTEM_TRACE_01
#define EPS_SYSTEM_TRACE_01(idx_, level_, msg_, para1_) \
    LSA_IDX_TRACE_01(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_)
#endif

#ifndef EPS_SYSTEM_TRACE_02
#define EPS_SYSTEM_TRACE_02(idx_, level_, msg_, para1_, para2_) \
    LSA_IDX_TRACE_02(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_)
#endif

#ifndef EPS_SYSTEM_TRACE_03
#define EPS_SYSTEM_TRACE_03(idx_, level_, msg_, para1_, para2_, para3_) \
    LSA_IDX_TRACE_03(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_)
#endif

#ifndef EPS_SYSTEM_TRACE_04
#define EPS_SYSTEM_TRACE_04(idx_, level_, msg_, para1_, para2_, para3_, para4_) \
    LSA_IDX_TRACE_04(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_)
#endif

#ifndef EPS_SYSTEM_TRACE_05
#define EPS_SYSTEM_TRACE_05(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_) \
    LSA_IDX_TRACE_05(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_)
#endif

#ifndef EPS_SYSTEM_TRACE_06
#define EPS_SYSTEM_TRACE_06(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_) \
    LSA_IDX_TRACE_06(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_)
#endif

#ifndef EPS_SYSTEM_TRACE_07
#define EPS_SYSTEM_TRACE_07(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_) \
    LSA_IDX_TRACE_07(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_)
#endif

#ifndef EPS_SYSTEM_TRACE_08
#define EPS_SYSTEM_TRACE_08(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_) \
    LSA_IDX_TRACE_08(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_)
#endif

#ifndef EPS_SYSTEM_TRACE_09
#define EPS_SYSTEM_TRACE_09(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_) \
    LSA_IDX_TRACE_09(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_)
#endif

#ifndef EPS_SYSTEM_TRACE_10
#define EPS_SYSTEM_TRACE_10(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_) \
    LSA_IDX_TRACE_10(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_)
#endif

#ifndef EPS_SYSTEM_TRACE_11
#define EPS_SYSTEM_TRACE_11(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_) \
    LSA_IDX_TRACE_11(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_)
#endif

#ifndef EPS_SYSTEM_TRACE_12
#define EPS_SYSTEM_TRACE_12(idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_) \
    LSA_IDX_TRACE_12(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, para1_, para2_, para3_, para4_, para5_, para6_, para7_, para8_, para9_, para10_, para11_, para12_)
#endif

#ifndef EPS_SYSTEM_TRACE_STRING
#define EPS_SYSTEM_TRACE_STRING(idx_, level_, msg_, st) \
    LSA_TRACE_STRING(TRACE_SUBSYS_EPS_SYSTEM, idx_, level_, msg_, st)
#endif
