#ifndef EPS_SHM_IF_H_           /* ----- reinclude-protection ----- */
...
typedef EPS_SHM_OPEN_OPTION_TYPE const* EPS_SHM_OPEN_OPTION_CONST_PTR_TYPE;
...
typedef EPS_SHM_FATAL_PAR_TYPE const* EPS_SHM_FATAL_PAR_CONST_PTR_TYPE;
...
typedef LSA_UINT16 (*EPS_SHM_OPEN_FCT)                   (LSA_VOID_PTR_TYPE hSys, EPS_SHM_OPEN_OPTION_CONST_PTR_TYPE pOption, struct eps_shm_hw_tag ** ppShmInstOut);
typedef LSA_UINT16 (*EPS_SHM_CLOSE_FCT)                  (struct eps_shm_hw_tag const* pShmInstIn);
...
typedef LSA_UINT16 (*EPS_SHM_SIG_FATAL_FCT)              (struct eps_shm_hw_tag const* pShmInstIn, EPS_SHM_FATAL_PAR_TYPE sFatal);
...
typedef EPS_SHM_IF_TYPE const* EPS_SHM_IF_CONST_PTR_TYPE;
...
typedef EPS_SHM_HW_TYPE const* EPS_SHM_HW_CONST_PTR_TYPE;

// install types
typedef LSA_VOID (*EPS_SHM_APPREADY_CBF)(EPS_SHM_HW_PTR_TYPE pHw, LSA_VOID_PTR_TYPE pHifHandle);
typedef LSA_VOID (*EPS_SHM_APPSHUTD_CBF)(EPS_SHM_HW_PTR_TYPE pHw);
...
typedef struct
{
	EPS_SHM_APPREADY_CBF     pAppReadyCbf;
	EPS_SHM_APPSHUTD_CBF     pAppShutdownCbf;

#if ( PSI_CFG_USE_PNTRC == 1 )
	EPS_SHM_TRACE_BUFFER_FULL_USER_CBF pTraceBufferFullCbf;
	EPS_SHM_PNTRC_PARAM_TYPE      sPntrcParam;
#endif
} EPS_SHM_INSTALL_ARGS_TYPE, *EPS_SHM_INSTALL_ARGS_PTR_TYPE;
typedef EPS_SHM_INSTALL_ARGS_TYPE const* EPS_SHM_INSTALL_ARGS_CONST_PTR_TYPE;

/*****************************************************************************/
/*  Prototypes                                                               */
/*****************************************************************************/

LSA_VOID   eps_shm_if_register          (EPS_SHM_IF_CONST_PTR_TYPE pPnDevIf);
